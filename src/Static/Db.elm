...
dbFromStaticFiles processesJson =
    Db.build
        ...
        , objectProductCategories = Db.rawJsonString StaticJson.objectProductCategoriesJson
        ...
        , veliProductCategories = Db.rawJsonString StaticJson.veliProductCategoriesJson
        }
