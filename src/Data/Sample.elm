...
samples =
    ...
    , section "Majoration de teinture personnalisée"
        ...
        , sample "co2 score for manteauCircuitEurope using custom dyeing weighting"
            ...
            , expected = Unit.kgCo2e 505.91380782727737
            }
        , sample "co2 score for pantalonCircuitEurope using custom dyeing weighting"
            ...
            , expected = Unit.kgCo2e 20.018083385586536
            }
        , sample "co2 score for robeCircuitBangladesh using custom dyeing weighting"
            ...
            , expected = Unit.kgCo2e 40.993996361512146
            }
        ]
    , section "Transport aérien personnalisé"
        [ sample "co2 score for tShirtCotonFrance using custom air transport ratio"
            ...
            , expected = Unit.kgCo2e 4.4587926414664345
            }
        ...
        , sample "co2 score for manteauCircuitEurope using custom air transport ratio"
            ...
            , expected = Unit.kgCo2e 513.527600996784
            }
        , sample "co2 score for pantalonCircuitEurope using custom air transport ratio"
            ...
            , expected = Unit.kgCo2e 23.28815979314244
            }
        , sample "co2 score for robeCircuitBangladesh using custom air transport ratio"
            ...
            , expected = Unit.kgCo2e 38.78750497344547
            }
        ]
    ...
    , section "Mix énergétique personnalisé"
        ...
        , section "À l'étape de Teinture"
            [ sample "co2 score for tShirtCotonFrance using custom country mix of 0"
                ...
                , expected = Unit.kgCo2e 4.3816337164664345
                }
            , sample "co2 score for tShirtCotonFrance using custom country mix of 0.5"
                { query =
                    tShirtCotonFrance
                        |> Inputs.setCustomCountryMix 2 (Just (Unit.kgCo2e 0.5))
                , expected = Unit.kgCo2e 4.580800383133101
                }
            , sample "co2 score for tShirtCotonFrance using custom country mix of 1.7"
                { query =
                    tShirtCotonFrance
                        |> Inputs.setCustomCountryMix 2 (Just (Unit.kgCo2e 1.7))
                , expected = Unit.kgCo2e 5.058800383133101
                }
            ]
        , section "À l'étape de Confection"
            [ sample "co2 score for tShirtCotonFrance using custom country mix of 0"
                ...
                , expected = Unit.kgCo2e 4.373365928966434
                }
            , sample "co2 score for tShirtCotonFrance using custom country mix of 0.5"
                { query =
                    tShirtCotonFrance
                        |> Inputs.setCustomCountryMix 3 (Just (Unit.kgCo2e 0.5))
                , expected = Unit.kgCo2e 4.623365928966434
                }
            , sample "co2 score for tShirtCotonFrance using custom country mix of 1.7"
                { query =
                    tShirtCotonFrance
                        |> Inputs.setCustomCountryMix 3 (Just (Unit.kgCo2e 1.7))
                , expected = Unit.kgCo2e 5.223365928966434
                }
            ]
            ...
            [ sample "co2 score for tShirtCotonFrance using custom country mix of 0"
                { query =
                    tShirtCotonFrance
                        ...
                        |> Inputs.setCustomCountryMix 2 (Just (Unit.kgCo2e 0))
                        |> Inputs.setCustomCountryMix 3 (Just (Unit.kgCo2e 0))
                , expected = Unit.kgCo2e 4.301937666466434
                }
            , sample "co2 score for tShirtCotonFrance using custom country mix of 0.5"
                { query =
                    tShirtCotonFrance
                        ...
                        |> Inputs.setCustomCountryMix 2 (Just (Unit.kgCo2e 0.5))
                        |> Inputs.setCustomCountryMix 3 (Just (Unit.kgCo2e 0.5))
                , expected = Unit.kgCo2e 4.991104333133101
                }
            , sample "co2 score for tShirtCotonFrance using custom country mix of 1.7"
                { query =
                    tShirtCotonFrance
                        ...
                        |> Inputs.setCustomCountryMix 2 (Just (Unit.kgCo2e 1.7))
                        |> Inputs.setCustomCountryMix 3 (Just (Unit.kgCo2e 1.7))
                , expected = Unit.kgCo2e 6.6451043331331
                }
            ]
        ]
    ]
