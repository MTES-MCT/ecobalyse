...
updateStageCountry : Label -> CountryCode.Code -> Query -> Query
...
default =
    ...
    , business = Nothing
    , countryDyeing = Just CountryCode.china
    , countryFabric = Just CountryCode.china
    , countryMaking = Just CountryCode.china
    , countrySpinning = Just CountryCode.china
    , disabledStages = []
    , dyeingProcessType = Nothing
    , fabricProcess = Nothing
    , fading = Nothing
