...
productToString : WebData (List Product) -> Query -> String
productToString productsData q =
    if q == emptyQuery then
        "Produit vide"
        ...
        productsData
            ...
            |> RemoteData.withDefault "Produit personnalisé"


productToCategory : WebData (List Product) -> Query -> String
productToCategory productsData q =
    productsData
        |> RemoteData.map
            (List.filterMap
                (\{ query, category } ->
