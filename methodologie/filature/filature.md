...
* Il est proposé, en plus des lins présents dans la Base Impacts (d'origine asiatique), un lin européen "European Flax" dont les données viennent d'une [étude ACV de la CELC](https://news.europeanflax.com/LCA/). Faute d'avoir trouvé un taux de perte dans cette étude, on prend celui de la Base Impacts pour la matière lin (étoupe).
{% endhint %}
