...
* Il est proposé, en plus des lins présents dans la Base Impacts (d'origine asiatique), un lin européen "European Flax" dont les données viennent d'une [étude ACV de la CELC](https://news.europeanflax.com/LCA/).&#x20;
{% endhint %}
