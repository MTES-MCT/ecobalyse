...
- Base is master, not main
- Step name
- Don't use useless remote and skip release commits
- Remove Snyk upgrades from changelog
- Remove closed scope to test release generation
...
- Trigger tag and release creation for test purposes
