...
Plus de 16 indicateurs seront disponibles d'ici la fin de l'année 2023 suite à ces deux chantiers en cours : \
\- enrichissement de la base de données (cf. travaux ADEME sur la Base Empreinte),\
\- travaux méthodologiques en cours sur le secteur Alimentaire (ex : introduction de l'indicateur "Biodiversité locale"). \
\
Indicateurs utilisés à date dans l'outil :&#x20;
