...
La principale différence entre le Coût Environnemental et le Score PEF consiste en l'ajout de [compléments](complements-hors-acv/) afin de répondre aux limites de la v.1.3 du PEFCR Apparel & Footwear.
...
2\) pour l'**épuisement des ressources en eau**, un impact est proposé, en construction, à partir des données de la [base EP\&L de Kering](https://kering-group.opendatasoft.com/pages/material-intensities/).
{% endhint %}
