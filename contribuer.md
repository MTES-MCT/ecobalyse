...
Sur le textile spécifiquement, des contributions sont souhaitées sur :

* les matières suivantes : Cachemire, Coton régénératif, Ecovero, Laine européenne, Laine recyclée, Laine régénérative, Lin européen, Lyocell, Modal, Polyuréthane, Soie
* Les procédés d'ennoblissement suivants : apprêts, teinture&#x20;
...
3. **Cohérence méthodologiques**                 \
   Les données alimentaires doivent suivre la méthodologie Agribalyse, et les données non-alimentaire les règles de modélisation transverse du PEF (hors base de données d'arrière plan).&#x20;
4. **Transparence et accessibilité** \
