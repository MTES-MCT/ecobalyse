...
class CustomAuthMiddleware(AbstractAuthenticationMiddleware):
    """JWT Authentication middleware that can return an empty user
    ...
    def __init__(
        ...
        retrieve_user_handler: Callable[
            [Token, ASGIConnection[Any, Any, Any, Any]], Awaitable[Any]
        ],
        scopes: Scopes,
        token_secret: str,
...
class CustomCookieAuthMiddleware(CustomAuthMiddleware):
