    ...
    <div class="oauth-flow ${e}" style="padding: 12px 0; margin-bottom:12px;">
      ...
      ${"authorizationCode"===e||"clientCredentials"===e||"implicit"===e||"password"===e?G`
          ...
          <div>
            ...
            ${"authorizationCode"===e||"clientCredentials"===e||"password"===e?G`
                <input
                ...
                <select style="margin-right:5px;${d?"display:none;":""}" class="${e} ${s} oauth-send-client-secret-in">
                   ${!a||a.includes("header")?G`<option value = 'header' .selected = ${"header"===o} > Authorization Header </option>`:""}
                   ${!a||a.includes("request-body")?G` <option value = 'request-body' .selected = ${"request-body"===o}> Request Body </option>`:""}
                </select>`:""}
            ${"authorizationCode"===e||"clientCredentials"===e||"implicit"===e||"password"===e?G`
                <button class="m-btn thin-border" part="btn btn-outline"
                  @click="${t=>{W_.call(this,s,e,c,p,t)}}"
                > GET TOKEN </button>`:""}
          </div>
          <div class="oauth-resp-display red-text small-font-size"></div>
          `:""}
    </div>
  `}function J_(e){var t;const r=null===(t=this.resolvedSpec.securitySchemes)||void 0===t?void 0:t.find((t=>t.securitySchemeId===e));if(r.user="",r.password="",r.value="",r.finalKeyValue="","true"===this.persistAuth){const e=B_.call(this);delete e[r.securitySchemeId],q_.call(this,e)}this.requestUpdate()}function K_(){var e;if(!this.resolvedSpec)return"";const t=null===(e=this.resolvedSpec.securitySchemes)||void 0===e?void 0:e.filter((e=>e.finalKeyValue));return t?G`
  <section id='auth' part="section-auth" style="text-align:left; direction:ltr; margin-top:24px; margin-bottom:24px;" class = 'observe-me ${"read focused".includes(this.renderStyle)?"section-gap--read-mode":"section-gap "}'>
    ...
    <div class="small-font-size" style="display:flex; align-items: center; min-height:30px">
      ${t.length>0?G`
          ...
          <button class="m-btn thin-border" part="btn btn-outline" @click=${()=>{D_.call(this)}}>CLEAR ALL API KEYS</button>`:G`<div class="red-text">No API key applied</div>`}
    </div>
    ${this.resolvedSpec.securitySchemes&&this.resolvedSpec.securitySchemes.length>0?G`
        <table role="presentation" id="auth-table" class='m-table padded-12' style="width:100%;">
          ${this.resolvedSpec.securitySchemes.filter((e=>e.type)).map((e=>{var t,r;return G`
              ...
              <td style="max-width:500px; overflow-wrap: break-word;">
                <div style="line-height:28px; margin-bottom:5px;">
                  ...
                  ${e.finalKeyValue?G`
                      ...
                      <button class="m-btn thin-border small" part="btn btn-outline" @click=${()=>{J_.call(this,e.securitySchemeId)}}>REMOVE</button>
                      `:""}
                </div>
                ${e.description?G`
                ...
                ${"apikey"===e.type.toLowerCase()||"http"===e.type.toLowerCase()&&"bearer"===(null===(t=e.scheme)||void 0===t?void 0:t.toLowerCase())?G`
                    <div style="margin-bottom:5px">
                      ${"apikey"===e.type.toLowerCase()?G`Send <code>${e.name}</code> in <code>${e.in}</code>`:G`Send <code>Authorization</code> in <code>header</code> containing the word <code>Bearer</code> followed by a space and a Token String.`}
                    </div>
                    <div style="max-height:28px;">
                      ${"cookie"!==e.in?G`
                          ...
                          <button class="m-btn thin-border" style = "margin-left:5px;"
                            ...
                            @click="${t=>{U_.call(this,e.securitySchemeId,t)}}">
                ...
                ${"http"===e.type.toLowerCase()&&"basic"===(null===(r=e.scheme)||void 0===r?void 0:r.toLowerCase())?G`
                    <div style="margin-bottom:5px">
...
`:void 0}function Y_(e){if(this.resolvedSpec.securitySchemes&&e){const t=[];return Array.isArray(e)?0===e.length?"":(e.forEach((e=>{const r=[],s=[];0===Object.keys(e).length?t.push({securityTypes:"None",securityDefs:[]}):(Object.keys(e).forEach((t=>{let n="";const i=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===t));e[t]&&Array.isArray(e[t])&&(n=e[t].join(", ")),i&&(s.push(i.typeDisplay),r.push({...i,scopes:n}))})),t.push({securityTypes:s.length>1?`${s[0]} + ${s.length-1} more`:s[0],securityDefs:r}))})),G`<div style="position:absolute; top:3px; right:2px; font-size:var(--font-size-small); line-height: 1.5;">
      <div style="position:relative; display:flex; min-width:350px; max-width:700px; justify-content: flex-end;">
        <svg width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" style="stroke:var(--fg3)"> <rect x="5" y="11" width="14" height="10" rx="2" /> <circle cx="12" cy="16" r="1" /> <path d="M8 11v-4a4 4 0 0 1 8 0v4" /></svg>
          ${t.map(((e,t)=>G`
          ${e.securityTypes?G`
              ${0!==t?G`<div style="padding:3px 4px;"> OR </div>`:""}
              <div class="tooltip">
                <div style = "padding:2px 4px; white-space:nowrap; text-overflow:ellipsis;max-width:150px; overflow:hidden;">
                  ${"true"===this.updateRoute&&"true"===this.allowAuthentication?G`<a part="anchor anchor-operation-security" href="#auth"> ${e.securityTypes} </a>`:G`${e.securityTypes}`}
                </div>
                <div class="tooltip-text" style="position:absolute; color: var(--fg); top:26px; right:0; border:1px solid var(--border-color);padding:2px 4px; display:block;">
                  ${e.securityDefs.length>1?G`<div>Requires <b>all</b> of the following </div>`:""}
                  <div style="padding-left: 8px">
                    ${e.securityDefs.map(((t,r)=>{const s=G`${""!==t.scopes?G`
                          <div>
                            <b>Required scopes:</b>
                            <br/>
                            <div style="margin-left:8px">
                              ${t.scopes.split(",").map(((e,t)=>G`${0===t?"":"┃"}<span>${e}</span>`))}
                            </div>
                          </div>`:""}`;return G`
                      ${"oauth2"===t.type?G`
                          <div>
                            ${e.securityDefs.length>1?G`<b>${r+1}.</b> &nbsp;`:"Needs"}
                            ...
                            <div>
                              ${e.securityDefs.length>1?G`<b>${r+1}.</b> &nbsp;`:G`Requires`}
  ...
  <div part="tab-panel" class="tab-panel col"
    ...
    <div part="tab-btn-row" class="tab-buttons row" style="width:100; overflow">
      ${e.map(((e,t)=>G`<button part="tab-btn" class="tab-btn ${0===t?"active":""}" data-tab = '${e.lang}${t}'> ${e.label||e.lang} </button>`))}
    </div>
    ${e.map(((e,t)=>{var r,s,n;return G`
      <div class="tab-content m-markdown" style= "display:${0===t?"block":"none"}" data-tab = '${e.lang}${t}'>
        <button class="toolbar-btn" style = "position:absolute; top:12px; right:8px" @click='${t=>{ut(e.source,t)}}'> Copy </button>
        <pre><code class="language">${Xe().languages[null===(r=e.lang)||void 0===r?void 0:r.toLowerCase()]?I_(Xe().highlight(e.source,Xe().languages[null===(s=e.lang)||void 0===s?void 0:s.toLowerCase()],null===(n=e.lang)||void 0===n?void 0:n.toLowerCase())):e.source}</code></pre>
      </div>`}))}
  </div>
  </section>`}function Z_(e){return G`
    <div class="req-res-title" style="margin-top:12px">CALLBACKS</div>
    ${Object.entries(e).map((e=>G`
      <div class="tiny-title" style="padding: 12px; border:1px solid var(--light-border-color)">
        ${e[0]}
        ${Object.entries(e[1]).map((e=>G`
          <div class="mono-font small-font-size" style="display:flex; margin-left:16px;">
            <div style="width:100%">
              ${Object.entries(e[1]).map((t=>{var r,s,n;return G`
                <div>
    ...
    `))}
  `}const Q_={},eR=T_(class extends P_{constructor(){super(...arguments),this.ot=Q_}render(e,t){return t()}update(e,[t,r]){if(Array.isArray(t)){if(Array.isArray(this.ot)&&this.ot.length===t.length&&t.every(((e,t)=>e===this.ot[t])))return J}else if(this.ot===t)return J;return this.ot=Array.isArray(t)?Array.from(t):t,this.render(t,r)}}),{I:tR}=ce,rR={},sR=T_(class extends P_{constructor(e){if(super(e),3!==e.type&&1!==e.type&&4!==e.type)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===J||t===K)return t;const r=e.element,s=e.name;if(3===e.type){if(t===r[s])return J}else if(4===e.type){if(!!t===r.hasAttribute(s))return J}else if(1===e.type&&r.getAttribute(s)===t+"")return J;return((e,t=rR)=>{e._$AH=t})(e),t}});var nR=r(657),iR=r.n(nR);const oR=c`
.border-top {
  border-top:1px solid var(--border-color);
}
.border{
...
`;var aR=r(859),lR=r.n(aR);function cR(e){if(void 0===e)return"";if(null===e)return"null";if(""===e)return"∅";if("boolean"==typeof e||"number"==typeof e)return`${e}`;if(Array.isArray(e))return e.map((e=>null===e?"null":""===e?"∅":e.toString().replace(/^ +| +$/g,(e=>"●".repeat(e.length)))||"")).join(", ");if("object"==typeof e){const t=Object.keys(e);return`{ ${t[0]}:${e[t[0]]}${t.length>1?",":""} ... }`}return e.toString().replace(/^ +| +$/g,(e=>"●".repeat(e.length)))||""}function pR(e){if(!e)return;let t="",r="";if(e.$ref){const r=e.$ref.lastIndexOf("/");t=`{recursive: ${e.$ref.substring(r+1)}} `}else e.type?(t=Array.isArray(e.type)?e.type.join(2===e.length?" or ":"┃"):e.type,(e.format||e.enum||e.const)&&(t=t.replace("string",e.enum?"enum":e.const?"const":e.format)),e.nullable&&(t+="┃null")):t=e.const?"const":0===Object.keys(e).length?"any":"{missing-type-info}";const s={type:t,format:e.format||"",pattern:e.pattern&&!e.enum?e.pattern:"",readOrWriteOnly:e.readOnly?"🆁":e.writeOnly?"🆆":"",deprecated:e.deprecated?"❌":"",examples:e.examples||e.example,default:cR(e.default),description:e.description||"",constrain:"",allowedValues:"",arrayType:"",html:""};if("{recursive}"===s.type?s.description=e.$ref.substring(e.$ref.lastIndexOf("/")+1):"{missing-type-info}"!==s.type&&"any"!==s.type||(s.description=s.description||""),s.allowedValues=e.const?e.const:Array.isArray(e.enum)?e.enum.map((e=>cR(e))).join("┃"):"","array"===t&&e.items){var n,i;const t=null===(n=e.items)||void 0===n?void 0:n.type,r=cR(e.items.default);s.arrayType=`${e.type} of ${Array.isArray(t)?t.join(""):t}`,s.default=r,s.allowedValues=e.items.const?e.const:Array.isArray(null===(i=e.items)||void 0===i?void 0:i.enum)?e.items.enum.map((e=>cR(e))).join("┃"):""}return t.match(/integer|number/g)&&(void 0===e.minimum&&void 0===e.exclusiveMinimum||(r+=void 0!==e.minimum?`Min ${e.minimum}`:`More than ${e.exclusiveMinimum}`),void 0===e.maximum&&void 0===e.exclusiveMaximum||(r+=void 0!==e.maximum?`${r?"┃":""}Max ${e.maximum}`:`${r?"┃":""}Less than ${e.exclusiveMaximum}`),void 0!==e.multipleOf&&(r+=`${r?"┃":""} multiple of ${e.multipleOf}`)),t.match(/string/g)&&(void 0!==e.minLength&&void 0!==e.maxLength?r+=`${r?"┃":""}${e.minLength} to ${e.maxLength} chars`:void 0!==e.minLength?r+=`${r?"┃":""}Min ${e.minLength} chars`:void 0!==e.maxLength&&(r+=`Max ${r?"┃":""}${e.maxLength} chars`)),s.constrain=r,s.html=`${s.type}~|~${s.readOrWriteOnly}~|~${s.constrain}~|~${s.default}~|~${s.allowedValues}~|~${s.pattern}~|~${s.description}~|~${e.title||""}~|~${s.deprecated?"deprecated":""}`,s}function uR(e){if("object"==typeof e&&!Array.isArray(e)){if(void 0!==e.value)return{Example:{...e}};const t=Object.entries(e).filter((([e,t])=>void 0!==t.value));if(0===t.length)return;return Object.fromEntries(t)}return Array.isArray(e)?e.reduce(((e,t,r)=>(e[`Example${r+1}`]={value:t},e)),{}):e?{Example:{value:e}}:void 0}function dR(e,t="string"){if(!e)return{exampleVal:"",exampleList:[]};if(e.constructor===Object){const t=Object.values(e).filter((e=>!1!==e["x-example-show-value"])).map((e=>({value:"boolean"==typeof e.value||"number"==typeof e.value?`${e.value}`:e.value||"",printableValue:cR(e.value),summary:e.summary||"",description:e.description||""})));return{exampleVal:t.length>0?t[0].value:"",exampleList:t}}if(Array.isArray(e)||(e=e?[e]:[]),0===e.length)return{exampleVal:"",exampleList:[]};if("array"===t){const[t]=e;return{exampleVal:t,exampleList:e.map((e=>({value:e,printableValue:cR(e)})))}}const r=e[0].toString(),s=e.map((e=>({value:e.toString(),printableValue:cR(e)})));return{exampleVal:r,exampleList:s}}function hR(e){const t=e.examples?e.examples[0]:null===e.example?null:e.example||void 0;if(""===t)return"";if(null===t)return null;if(0===t)return 0;if(!1===t)return!1;if(t instanceof Date)switch(e.format.toLowerCase()){case"date":return t.toISOString().split("T")[0];case"time":return t.toISOString().split("T")[1];default:return t.toISOString()}if(t)return t;if(0===Object.keys(e).length)return null;if(e.$ref)return{};if(!1===e.const||0===e.const||null===e.const||""===e.const)return e.const;if(e.const)return e.const;if(e.default)return e.default;const r=Array.isArray(e.type)?e.type[0]:e.type;if(!r)return null;if(r.match(/^integer|^number/g)){const t=Number.isNaN(Number(e.multipleOf))?void 0:Number(e.multipleOf),s=Number.isNaN(Number(e.maximum))?void 0:Number(e.maximum),n=Number.isNaN(Number(e.minimum))?Number.isNaN(Number(e.exclusiveMinimum))?s||0:Number(e.exclusiveMinimum)+(r.startsWith("integer")?1:.001):Number(e.minimum);return t?t>=n?t:n%t==0?n:Math.ceil(n/t)*t:n}if(r.match(/^boolean/g))return!1;if(r.match(/^null/g))return null;if(r.match(/^string/g)){if(e.enum)return e.enum[0];if(e.const)return e.const;if(e.pattern)try{return new(lR())(e.pattern).gen()}catch{return e.pattern}if(!e.format){const t=Number.isNaN(e.minLength)?void 0:Number(e.minLength),r=Number.isNaN(e.maxLength)?void 0:Number(e.maxLength),s=t||(r>6?6:r||void 0);return s?"A".repeat(s):"string"}{const t=`${Date.now().toString(16)}${Math.random().toString(16)}0`.repeat(16);switch(e.format.toLowerCase()){case"url":case"uri":return"http://example.com";case"date":return new Date(0).toISOString().split("T")[0];case"time":return new Date(0).toISOString().split("T")[1];case"date-time":return new Date(0).toISOString();case"duration":return"P3Y6M4DT12H30M5S";case"email":case"idn-email":return"user@example.com";case"hostname":case"idn-hostname":return"www.example.com";case"ipv4":return"198.51.100.42";case"ipv6":return"2001:0db8:5b96:0000:0000:426f:8e17:642a";case"uuid":return[t.substring(0,8),t.substring(8,12),`4000-8${t.substring(13,16)}`,t.substring(16,28)].join("-");case"byte":return"ZXhhbXBsZQ==";default:return""}}}return null}function mR(e,t=1){const r="  ".repeat(t);let s="";if(1===t&&"object"!=typeof e)return`\n${r}${e.toString()}`;for(const n in e){const i=e[n]["::XML_TAG"]||n;let o="";o=Array.isArray(e[n])?i[0]["::XML_TAG"]||`${n}`:i,n.startsWith("::")||(s=Array.isArray(e[n])||"object"==typeof e[n]?`${s}\n${r}<${o}>${mR(e[n],t+1)}\n${r}</${o}>`:`${s}\n${r}<${o}>${e[n].toString()}</${o}>`)}return s}function fR(e,t){var r,s,n,i;"object"==typeof t&&null!==t&&(e.title&&(t["::TITLE"]=e.title),e.description&&(t["::DESCRIPTION"]=e.description),null!==(r=e.xml)&&void 0!==r&&r.name&&(t["::XML_TAG"]=null===(n=e.xml)||void 0===n?void 0:n.name),null!==(s=e.xml)&&void 0!==s&&s.wrapped&&(t["::XML_WRAP"]=null===(i=e.xml)||void 0===i?void 0:i.wrapped.toString()))}function gR(e){if("object"==typeof e&&null!==e){delete e["::TITLE"],delete e["::DESCRIPTION"],delete e["::XML_TAG"],delete e["::XML_WRAP"];for(const t in e)gR(e[t])}}function yR(e,t,r){for(const s in t)t[s][r]=e}function vR(e,t,r){let s=0;const n={};for(const i in e){for(const o in r)if(n[`example-${s}`]={...e[i]},n[`example-${s}`][t]=r[o],s++,s>=10)break;if(s>=10)break}return n}function bR(e,t={}){let r={};if(e){if(e.allOf){var s,n;const i={};if(!(1!==e.allOf.length||null!==(s=e.allOf[0])&&void 0!==s&&s.properties||null!==(n=e.allOf[0])&&void 0!==n&&n.items))return e.allOf[0].$ref?"{  }":e.allOf[0].readOnly&&t.includeReadOnly?hR(e.allOf[0]):void 0;e.allOf.forEach((e=>{if("object"===e.type||e.properties||e.allOf||e.anyOf||e.oneOf){const r=bR(e,t);Object.assign(i,r)}else if("array"===e.type||e.items){const r=[bR(e,t)];Object.assign(i,r)}else{if(!e.type)return"";{const t=`prop${Object.keys(i).length}`;i[t]=hR(e)}}})),r=i}else if(e.oneOf){const s={};if(e.properties)for(const r in e.properties){var i;e.properties[r].properties||null!==(i=e.properties[r].properties)&&void 0!==i&&i.items?s[r]=bR(e.properties[r],t):s[r]=hR(e.properties[r])}if(e.oneOf.length>0){let n=0;for(const i in e.oneOf){const o=bR(e.oneOf[i],t);for(const t in o){let a;if(Object.keys(s).length>0){if(null===o[t]||"object"!=typeof o[t])continue;a=Object.assign(o[t],s)}else a=o[t];r[`example-${n}`]=a,fR(e.oneOf[i],r[`example-${n}`]),n++}}}}else if(e.anyOf){let s;if("object"===e.type||e.properties){s={"example-0":{}};for(const r in e.properties){if(e.example){s=e;break}e.properties[r].deprecated&&!t.includeDeprecated||e.properties[r].readOnly&&!t.includeReadOnly||e.properties[r].writeOnly&&!t.includeWriteOnly||(s=vR(s,r,bR(e.properties[r],t)))}}let n=0;for(const i in e.anyOf){const o=bR(e.anyOf[i],t);for(const t in o){if(void 0!==s)for(const e in s)r[`example-${n}`]={...s[e],...o[t]};else r[`example-${n}`]=o[t];fR(e.anyOf[i],r[`example-${n}`]),n++}}}else if("object"===e.type||e.properties)if(r["example-0"]={},fR(e,r["example-0"]),e.example)r["example-0"]=e.example;else{for(const s in e.properties){var o,a,l,c,p,u;if((null===(o=e.properties[s])||void 0===o||!o.deprecated||t.includeDeprecated)&&(null===(a=e.properties[s])||void 0===a||!a.readOnly||t.includeReadOnly)&&(null===(l=e.properties[s])||void 0===l||!l.writeOnly||t.includeWriteOnly))if("array"===(null===(c=e.properties[s])||void 0===c?void 0:c.type)||null!==(p=e.properties[s])&&void 0!==p&&p.items)if(e.properties[s].example)yR(e.properties[s].example,r,s);else if(null!==(u=e.properties[s])&&void 0!==u&&null!==(u=u.items)&&void 0!==u&&u.example)yR([e.properties[s].items.example],r,s);else{const n=bR(e.properties[s].items,t);if(t.useXmlTagForProp){var d,h;const t=(null===(d=e.properties[s].xml)||void 0===d?void 0:d.name)||s;r=null!==(h=e.properties[s].xml)&&void 0!==h&&h.wrapped?vR(r,t,JSON.parse(`{ "${t}" : { "${t}" : ${JSON.stringify(n["example-0"])} } }`)):vR(r,t,n)}else{const e=[];for(const t in n)e[t]=[n[t]];r=vR(r,s,e)}}else r=vR(r,s,bR(e.properties[s],t))}if("object"==typeof e.additionalProperties){const s=e.additionalProperties["x-additionalPropertiesName"]||"property";r=vR(r,`${s}1`,bR(e.additionalProperties,t)),r=vR(r,`${s}2`,bR(e.additionalProperties,t))}}else{if("array"!==e.type&&!e.items)return{"example-0":hR(e)};var m;if(e.items||e.example)if(e.example)r["example-0"]=e.example;else if(null!==(m=e.items)&&void 0!==m&&m.example)r["example-0"]=[e.items.example];else{const s=bR(e.items,t);let n=0;for(const t in s)r[`example-${n}`]=[s[t]],fR(e.items,r[`example-${n}`]),n++}else r["example-0"]=[]}return r}}function xR(e,t=0){var r;let s=(e.description||e.title)&&(e.minItems||e.maxItems)?'<span class="descr-expand-toggle">➔</span>':"";if(e.title?s=e.description?`${s} <b>${e.title}:</b> ${e.description}<br/>`:`${s} ${e.title}<br/>`:e.description&&(s=`${s} ${e.description}<br/>`),e.minItems&&(s=`${s} <b>Min Items:</b> ${e.minItems}`),e.maxItems&&(s=`${s} <b>Max Items:</b> ${e.maxItems}`),t>0&&null!==(r=e.items)&&void 0!==r&&r.description){let t="";e.items.minProperties&&(t=`<b>Min Properties:</b> ${e.items.minProperties}`),e.items.maxProperties&&(t=`${t} <b>Max Properties:</b> ${e.items.maxProperties}`),s=`${s} ⮕ ${t} [ ${e.items.description} ] `}return s}function wR(e,t,r=0,s=""){if(e){if(e.allOf){const s={};if(1===e.allOf.length&&!e.allOf[0].properties&&!e.allOf[0].items)return`${pR(e.allOf[0]).html}`;e.allOf.map(((e,t)=>{if("object"===e.type||e.properties||e.allOf||e.anyOf||e.oneOf){const n=(e.anyOf||e.oneOf)&&t>0?t:"",i=wR(e,{},r+1,n);Object.assign(s,i)}else if("array"===e.type||e.items){const t=wR(e,{},r+1);Object.assign(s,t)}else{if(!e.type)return"";{const t=`prop${Object.keys(s).length}`,r=pR(e);s[t]=`${r.html}`}}})),t=s}else if(e.anyOf||e.oneOf){if(t["::description"]=e.description||"","object"===e.type||e.properties){t["::description"]=e.description||"",t["::type"]="object";for(const s in e.properties)e.required&&e.required.includes(s)?t[`${s}*`]=wR(e.properties[s],{},r+1):t[s]=wR(e.properties[s],{},r+1)}const n={},i=e.anyOf?"anyOf":"oneOf";e[i].forEach(((e,t)=>{if("object"===e.type||e.properties||e.allOf||e.anyOf||e.oneOf){const r=wR(e,{});n[`::OPTION~${t+1}${e.title?`~${e.title}`:""}`]=r,n[`::OPTION~${t+1}${e.title?`~${e.title}`:""}`]["::readwrite"]="",n["::type"]="xxx-of-option"}else if("array"===e.type||e.items){const r=wR(e,{});n[`::OPTION~${t+1}${e.title?`~${e.title}`:""}`]=r,n[`::OPTION~${t+1}${e.title?`~${e.title}`:""}`]["::readwrite"]="",n["::type"]="xxx-of-array"}else{const r=`::OPTION~${t+1}${e.title?`~${e.title}`:""}`;n[r]=`${pR(e).html}`,n["::type"]="xxx-of-option"}})),t[e.anyOf?`::ANY~OF ${s}`:`::ONE~OF ${s}`]=n,t["::type"]="object"}else if(Array.isArray(e.type)){const s=JSON.parse(JSON.stringify(e)),o=[],a=[];let l;var n;if(s.type.forEach((e=>{var t,r;e.match(/integer|number|string|null|boolean/g)?o.push(e):"array"===e&&"string"==typeof(null===(t=s.items)||void 0===t?void 0:t.type)&&null!==(r=s.items)&&void 0!==r&&r.type.match(/integer|number|string|null|boolean/g)?"string"===s.items.type&&s.items.format?o.push(`[${s.items.format}]`):o.push(`[${s.items.type}]`):a.push(e)})),o.length>0&&(s.type=o.join(2===o.length?" or ":"┃"),l=pR(s),0===a.length))return`${(null===(n=l)||void 0===n?void 0:n.html)||""}`;if(a.length>0){var i;t["::type"]="object";const n={"::type":"xxx-of-option"};a.forEach(((t,i)=>{if("null"===t)n[`::OPTION~${i+1}`]="NULL~|~~|~~|~~|~~|~~|~~|~~|~";else if("integer, number, string, boolean,".includes(`${t},`)){s.type=Array.isArray(t)?t.join("┃"):t;const e=pR(s);n[`::OPTION~${i+1}`]=e.html}else if("object"===t){const t={"::title":e.title||"","::description":e.description||"","::type":"object","::deprecated":e.deprecated||!1};for(const s in e.properties)e.required&&e.required.includes(s)?t[`${s}*`]=wR(e.properties[s],{},r+1):t[s]=wR(e.properties[s],{},r+1);n[`::OPTION~${i+1}`]=t}else"array"===t&&(n[`::OPTION~${i+1}`]={"::title":e.title||"","::description":e.description||"","::type":"array","::props":wR(e.items,{},r+1)})})),n[`::OPTION~${a.length+1}`]=(null===(i=l)||void 0===i?void 0:i.html)||"",t["::ONE~OF"]=n}}else if("object"===e.type||e.properties){t["::title"]=e.title||"",t["::description"]=xR(e,r),t["::type"]="object",(Array.isArray(e.type)&&e.type.includes("null")||e.nullable)&&(t["::dataTypeLabel"]="object or null",t["::nullable"]=!0),t["::deprecated"]=e.deprecated||!1,t["::readwrite"]=e.readOnly?"readonly":e.writeOnly?"writeonly":"";for(const s in e.properties)e.required&&e.required.includes(s)?t[`${s}*`]=wR(e.properties[s],{},r+1):t[s]=wR(e.properties[s],{},r+1);for(const s in e.patternProperties)t[`[pattern: ${s}]`]=wR(e.patternProperties[s],t,r+1);e.additionalProperties&&(t["[any-key]"]=wR(e.additionalProperties,{}))}else{if("array"!==e.type&&!e.items){const t=pR(e);return null!=t&&t.html?`${t.html}`:""}var o;t["::title"]=e.title||"",t["::description"]=xR(e,r),t["::type"]="array",(Array.isArray(e.type)&&e.type.includes("null")||e.nullable)&&(t["::dataTypeLabel"]="array or null",t["::nullable"]=!0),t["::deprecated"]=e.deprecated||!1,t["::readwrite"]=e.readOnly?"readonly":e.writeOnly?"writeonly":"",null!==(o=e.items)&&void 0!==o&&o.items&&(t["::array-type"]=e.items.items.type),t["::props"]=wR(e.items,{},r+1)}return t}}function $R(e,t,r={},s={},n=!0,i=!0,o="json",a=!1){const l=[];if(r)for(const e in r){let s="",n="json";if(null!=t&&t.toLowerCase().includes("json")){if("text"===o)s="string"==typeof r[e].value?r[e].value:JSON.stringify(r[e].value,void 0,2),n="text";else if(s=r[e].value,"string"==typeof r[e].value)try{const t=r[e].value;s=JSON.parse(t),n="json"}catch{n="text",s=r[e].value}}else s=r[e].value,n="text";l.push({exampleId:e,exampleSummary:r[e].summary||e,exampleDescription:r[e].description||"",exampleType:t,exampleValue:s,exampleFormat:n})}else if(s){let e="",r="json";if(null!=t&&t.toLowerCase().includes("json")){if("text"===o)e="string"==typeof s?s:JSON.stringify(s,void 0,2),r="text";else if("object"==typeof s)e=s,r="json";else if("string"==typeof s)try{e=JSON.parse(s),r="json"}catch{r="text",e=s}}else e=s,r="text";l.push({exampleId:"Example",exampleSummary:"",exampleDescription:"",exampleType:t,exampleValue:e,exampleFormat:r})}if(0===l.length||!0===a)if(e)if(e.example)l.push({exampleId:"Example",exampleSummary:"",exampleDescription:"",exampleType:t,exampleValue:e.example,exampleFormat:null!=t&&t.toLowerCase().includes("json")&&"object"==typeof e.example?"json":"text"});else if(null!=t&&t.toLowerCase().includes("json")||null!=t&&t.toLowerCase().includes("text")||null!=t&&t.toLowerCase().includes("*/*")||null!=t&&t.toLowerCase().includes("xml")){let r="",s="",a="",u="";var c,p;null!=t&&t.toLowerCase().includes("xml")?(r=null!==(c=e.xml)&&void 0!==c&&c.name?`<${e.xml.name} ${e.xml.namespace?`xmlns="${e.xml.namespace}"`:""}>`:"<root>",s=null!==(p=e.xml)&&void 0!==p&&p.name?`</${e.xml.name}>`:"</root>",a="text"):a=o;const d=bR(e,{includeReadOnly:n,includeWriteOnly:i,deprecated:!0,useXmlTagForProp:null==t?void 0:t.toLowerCase().includes("xml")});let h=0;for(const e in d){if(!d[e])continue;const n=d[e]["::TITLE"]||"Example "+ ++h,i=d[e]["::DESCRIPTION"]||"";null!=t&&t.toLowerCase().includes("xml")?u=`<?xml version="1.0" encoding="UTF-8"?>\n${r}${mR(d[e],1)}\n${s}`:(gR(d[e]),u="text"===o?JSON.stringify(d[e],null,2):d[e]),l.push({exampleId:e,exampleSummary:n,exampleDescription:i,exampleType:t,exampleFormat:a,exampleValue:u})}}else null!=t&&t.toLowerCase().includes("jose")?l.push({exampleId:"Example",exampleSummary:"Base64 Encoded",exampleDescription:"",exampleType:t,exampleValue:e.pattern||"bXJpbg==",exampleFormat:"text"}):l.push({exampleId:"Example",exampleSummary:"",exampleDescription:"",exampleType:t,exampleValue:"",exampleFormat:"text"});else l.push({exampleId:"Example",exampleSummary:"",exampleDescription:"",exampleType:t,exampleValue:"",exampleFormat:"text"});return l}function SR(e){return"application/json"===e?"json":"application/xml"===e?"xml":null}function ER(e){if(e.schema)return[e.schema,null,null];if(e.content)for(const t of Object.keys(e.content))if(e.content[t].schema)return[e.content[t].schema,SR(t),e.content[t]];return[null,null,null]}lR().prototype.randInt=e=>e,customElements.define("json-tree",class extends ue{static get properties(){return{data:{type:Object},renderStyle:{type:String,attribute:"render-style"}}}static get styles(){return[Ze,oR,Qe,c`
      :host{
        display:flex;
      }
      ...
      <div class = "json-tree"  @click='${e=>{e.target.classList.contains("btn-copy")?ut(JSON.stringify(this.data,null,2),e):this.toggleExpand(e)}}'>
        <div class='toolbar'>
          <button class="toolbar-btn btn-copy" part="btn btn-fill btn-copy"> Copy </button>
        </div>
          ${this.generateTree(this.data,!0)}
      </div>
    `}generateTree(e,t=!1){if(null===e)return G`<span class="null">null</span>${t?"":","}`;if("object"==typeof e&&e instanceof Date==0){const r=Array.isArray(e)?"array":"pure_object";return 0===Object.keys(e).length?G`${Array.isArray(e)?"[ ],":"{ },"}`:G`
      <div class="open-bracket expanded ${"array"===r?"array":"object"}" > ${"array"===r?"[":"{"}</div>
      <div class="inside-bracket">
        ${Object.keys(e).map(((t,s,n)=>G`
          <div class="item">
            ${"pure_object"===r?G`"${t}":`:""}
...
`;function AR(e){const t=new Ke.Renderer;return t.heading=(t,r,s,n)=>`<h${r} class="observe-me" id="${e}--${n.slug(s)}">${t}</h${r}>`,t}function OR(e){const t=e.target.closest(".tag-container").querySelector(".tag-description"),r=e.target.closest(".tag-container").querySelector(".tag-icon");t&&r&&(t.classList.contains("expanded")?(t.style.maxHeight=0,t.classList.replace("expanded","collapsed"),r.classList.replace("expanded","collapsed")):(t.style.maxHeight=`${t.scrollHeight}px`,t.classList.replace("collapsed","expanded"),r.classList.replace("collapsed","expanded")))}function jR(e,t="",r=""){var s,n,i,o,a,l,c,p,u;const d=new Set;for(const t in e.responses)for(const r in null===(h=e.responses[t])||void 0===h?void 0:h.content){var h;d.add(r.trim())}const m=[...d].join(", "),f=this.resolvedSpec.securitySchemes.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))}))||[],g=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===ct&&"-"!==e.value));g&&f.push(g);const y=e.xCodeSamples?X_.call(this,e.xCodeSamples):"";return G`
    ${"read"===this.renderStyle?G`<div class='divider' part="operation-divider"></div>`:""}
    <div class='expanded-endpoint-body observe-me ${e.method} ${e.deprecated?"deprecated":""} ' part="section-operation ${e.elementId}" id='${e.elementId}'>
      ${"focused"===this.renderStyle&&"General ⦂"!==t?G`
          <div class="tag-container" part="section-operation-tag">
            ...
            ${r?G`
                ...
                <div class="tag-description collapsed" style="max-height:0px; overflow:hidden; margin-top:16px; border:1px solid var(--border-color)">
                  <div class="m-markdown" style="padding:8px"> ${I_(Ke(r))}</div>
                </div>`:""}
          </div>
        `:""}
      ${e.deprecated?G`<div class="bold-text red-text"> DEPRECATED </div>`:""}
      ${G`
        ${e.xBadges&&(null===(s=e.xBadges)||void 0===s?void 0:s.length)>0?G`
            <div style="display:flex; flex-wrap:wrap; margin-bottom: -24px; font-size: var(--font-size-small);">
              ${e.xBadges.map((e=>"none"===e.color?"":G`<span style="margin:1px; margin-right:5px; padding:1px 8px; font-weight:bold; border-radius:12px;  background-color: var(--light-${e.color}, var(--input-bg)); color:var(--${e.color}); border:1px solid var(--${e.color})">${e.label}</span>`))}
            </div>
            `:""}
        <h2 part="section-operation-summary"> ${e.shortSummary||`${e.method.toUpperCase()} ${e.path}`}</h2>
        ${e.isWebhook?G`<span part="section-operation-webhook" style="color:var(--primary-color); font-weight:bold; font-size: var(--font-size-regular);"> WEBHOOK </span>`:G`
      ...
      ${e.description?G`<div class="m-markdown"> ${I_(Ke(e.description))}</div>`:""}
      ${Y_.call(this,e.security)}
      ${null!==(n=e.externalDocs)&&void 0!==n&&n.url||null!==(i=e.externalDocs)&&void 0!==i&&i.description?G`<div style="background-color:var(--bg3); padding:2px 8px 8px 8px; margin:8px 0; border-radius:var(--border-radius)">
            <div class="m-markdown"> ${I_(Ke((null===(o=e.externalDocs)||void 0===o?void 0:o.description)||""))} </div>
            ${null!==(a=e.externalDocs)&&void 0!==a&&a.url?G`<a style="font-family:var(--font-mono); font-size:var(--font-size-small)" href="${null===(l=e.externalDocs)||void 0===l?void 0:l.url}" target="_blank">
      ...
      <div class='expanded-req-resp-container'>
        ...
        ${e.callbacks?Z_.call(this,e.callbacks):""}
  ...
  `}function TR(){return this.resolvedSpec?G`
  ${this.resolvedSpec.tags.map((e=>G`
    <section id="${e.elementId}" part="section-tag" class="regular-font section-gap--read-mode observe-me" style="border-top:1px solid var(--primary-color);">
      ...
      ${I_(`\n          <div class="m-markdown regular-font">\n          ${Ke(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:AR(e.elementId)}:void 0)}\n        </div>`)}
      </div>
    </section>
    <section class="regular-font section-gap--read-mode" part="section-operations-in-tag">
      ${e.paths.map((e=>jR.call(this,e)))}
    </section>
    `))}
`:""}function PR(e){return G`
  ...
  ${"table"===this.schemaStyle?G`
      ...
      <schema-tree
        ...
        exportparts = "schema-description:schema-description, schema-multiline-toggle:schema-multiline-toggle"
      > </schema-tree>`}
  </div>`}function CR(e,t){return-1!==e.id.indexOf("schemas-")?PR.call(this,e):G`
  <div class='divider'></div>
  <div class='expanded-endpoint-body observe-me ${e.name}' id='cmp--${e.id}' >
    ${G`
  ...
  `}function IR(){return this.resolvedSpec?G`
  ${this.resolvedSpec.components.map((e=>G`
    <div id="cmp--${e.name.toLowerCase()}" class='regular-font section-gap--read-mode observe-me' style="border-top:1px solid var(--primary-color);">
      ...
      <div class="regular-font-size">
        ${I_(`<div class='m-markdown regular-font'>${Ke(e.description?e.description:"")}</div>`)}
      </div>
    </div>
    ...
    `))}
`:""}function _R(){const e=new Ke.Renderer;return e.heading=(e,t,r,s)=>`<h${t} class="observe-me" id="overview--${s.slug(r)}">${e}</h${t}>`,e}function RR(){var e,t,r,s;return G`
    <section id="overview" part="section-overview"
      class="observe-me ${"view"===this.renderStyle?"section-gap":"section-gap--read-mode"}">
      ${null!==(e=this.resolvedSpec)&&void 0!==e&&e.info?G`
          ...
          <div id="api-info" style="font-size:calc(var(--font-size-regular) - 1px); margin-top:8px;">
            ${null!==(t=this.resolvedSpec.info.contact)&&void 0!==t&&t.email?G`<span>${this.resolvedSpec.info.contact.name||"Email"}:
                <a href="mailto:${this.resolvedSpec.info.contact.email}" part="anchor anchor-overview">${this.resolvedSpec.info.contact.email}</a>
              </span>`:""}
            ${null!==(r=this.resolvedSpec.info.contact)&&void 0!==r&&r.url?G`<span>URL: <a href="${this.resolvedSpec.info.contact.url}" part="anchor anchor-overview">${this.resolvedSpec.info.contact.url}</a></span>`:""}
            ...
            ${this.specUrl&&"true"===this.allowSpecFileDownload?G`
                <div style="display:flex; margin:12px 0; gap:8px; justify-content: start;">
                  <button class="m-btn thin-border" style="min-width:170px" part="btn btn-outline" @click='${e=>{mt(this.specUrl,"openapi-spec")}}'>Download OpenAPI spec</button>
                  ${null!==(s=this.specUrl)&&void 0!==s&&s.trim().toLowerCase().endsWith("json")?G`<button class="m-btn thin-border" style="width:200px" part="btn btn-outline" @click='${e=>{ft(this.specUrl)}}'>View OpenAPI spec (New Tab)</button>`:""}
                </div>`:""}
          </div>
          <slot name="overview"></slot>
          <div id="api-description">
          ${this.resolvedSpec.info.description?G`${I_(`\n                <div class="m-markdown regular-font">\n                ${Ke(this.resolvedSpec.info.description,"true"===this.infoDescriptionHeadingsInNavBar?{renderer:_R()}:void 0)}\n              </div>`)}`:""}
          </div>
        `:""}
    </section>
  `}function FR(e){var t;const r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers.find((t=>t.url===e));return!!r&&(this.selectedServer=r,this.requestUpdate(),this.dispatchEvent(new CustomEvent("api-server-change",{bubbles:!0,composed:!0,detail:{selectedServer:r}})),!0)}function MR(e,t){const r=[...e.currentTarget.closest("table").querySelectorAll("input, select")];let s=t.url;r.forEach((e=>{const t=new RegExp(`{${e.dataset.var}}`,"g");s=s.replace(t,e.value)})),t.computedUrl=s,this.requestUpdate()}function LR(){return this.selectedServer&&this.selectedServer.variables?G`
    <div class="table-title">SERVER VARIABLES</div>
    <table class='m-table' role='presentation'>
      ${Object.entries(this.selectedServer.variables).map((e=>G`
        <tr>
          ...
          <td>
            ...
            <select
              data-var = "${e[0]}"
              @input = ${e=>{MR.call(this,e,this.selectedServer)}}
            >
            ${Object.entries(e[1].enum).map((t=>e[1].default===t[1]?G`
              <option
                selected
                label = ${t[1]}
                value = ${t[1]}
        ...
        ${e[1].description?G`<tr><td colspan="2" style="border:none"><span class="m-markdown-small"> ${I_(Ke(e[1].description))} </span></td></tr>`:""}
      `))}
    </table>
    `:""}function DR(){var e,t,r;return!this.resolvedSpec||this.resolvedSpec.specLoadError?"":G`
  <section id = 'servers' part="section-servers" style="text-align:left; direction:ltr; margin-top:24px; margin-bottom:24px;" class='regular-font observe-me ${"read focused".includes(this.renderStyle)?"section-gap--read-mode":"section-gap"}'>
    ...
    <div class = 'mono-font' style='margin: 12px 0; font-size:calc(var(--font-size-small) + 1px);'>
      ${this.resolvedSpec.servers&&0!==(null===(e=this.resolvedSpec.servers)||void 0===e?void 0:e.length)?G`
          ${null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers.map(((e,t)=>G`
            <input type = 'radio'
              name = 'api_server'
              id = 'srvr-opt-${t}'
              value = '${e.url}'
            ...
            />
              <label style='cursor:pointer' for='srvr-opt-${t}'>
                ${e.url} ${e.description?G`- <span class='regular-font'>${e.description} </span>`:""}
              </label>
            <br/>
          `))}
      `:""}
  ...
  <nav class='nav-bar ${this.renderStyle}' part='section-navbar'>
    <slot name='nav-logo' class='logo'></slot>
    ${"false"===this.allowSearch&&"false"===this.allowAdvancedSearch?"":G`
        <div style='display:flex; flex-direction:row; justify-content:center; align-items:stretch; padding:8px 24px 12px 24px; ${"false"===this.allowAdvancedSearch?"border-bottom: 1px solid var(--nav-hover-bg-color)":""}' part='section-navbar-search'>
          ${"false"===this.allowSearch?"":G`
            ...
            `}
          ${"false"===this.allowAdvancedSearch||this.searchVal?"":G`
      ...
      `}
    ${G`<nav class='nav-scroll' tabindex='-1' part='section-navbar-scroll' @click='${e=>qR.call(this,e)}' @keyup='${e=>qR.call(this,e)}' >
      ${"false"!==this.showInfo&&this.resolvedSpec.info?G`
          ${"true"===this.infoDescriptionHeadingsInNavBar?G`
              ...
              <div class='overview-headers'>
                ${this.resolvedSpec.infoDescriptionHeaders.map((e=>G`
                  <div
      ...
      ${"false"===this.allowServerSelection?"":G`<div class='nav-bar-info ${this.navActiveItemMarker}' id='link-servers' data-action='navigate' data-content-id='servers' tabindex='0' part='section-navbar-item section-navbar-servers'> API Servers </div>`}
      ${"false"!==this.allowAuthentication&&this.resolvedSpec.securitySchemes?G`<div class='nav-bar-info ${this.navActiveItemMarker}' id='link-auth' data-action='navigate' data-content-id='auth' tabindex='0' part='section-navbar-item section-navbar-auth'> Authentication </div>`:""}
      ...
      <!-- TAGS AND PATHS-->
      ${this.resolvedSpec.tags.filter((e=>e.paths.filter((t=>dt(this.searchVal,t,e.name))).length)).map((e=>{var t;return G`
          <div class='nav-bar-tag-and-paths ${"read"===this.renderStyle||e.expanded?"expanded":"collapsed"}' >
            ${"General ⦂"===e.name?G`<hr style='border:none; border-top: 1px dotted var(--nav-text-color); opacity:0.3; margin:-1px 0 0 0;'/>`:G`
                <div
              ...
              `}
            ${"true"===this.infoDescriptionHeadingsInNavBar?G`
                ${"focused"===this.renderStyle&&"expand-collapse"===this.onNavTagClick?"":G`
            ...
            <div class='nav-bar-paths-under-tag' style='max-height:${e.expanded||"read"===this.renderStyle?50*((null===(t=e.paths)||void 0===t?void 0:t.length)||1):0}px;'>
              ...
              ${e.paths.filter((t=>!this.searchVal||dt(this.searchVal,t,e.name))).map((e=>G`
              <div
              ...
              >
                <span style = 'display:flex; pointer-events: none; align-items:start; ${e.deprecated?"filter:opacity(0.5)":""}'>
                  ${G`<span class='nav-method ${this.showMethodInNavBar} ${e.method}' style='pointer-events: none;'>
                      ${"as-colored-block"===this.showMethodInNavBar?e.method.substring(0,3).toUpperCase():e.method.toUpperCase()}
                    </span>`}
                  ${e.isWebhook?G`<span style='font-weight:bold; pointer-events: none; margin-right:8px; font-size: calc(var(--font-size-small) - 2px)'>WEBHOOK</span>`:""}
                  ${"true"===this.usePathInNavBar?G`<span style='pointer-events: none;' class='mono-font'>${e.path}</span>`:e.summary||e.shortSummary}
                </span>
              </div>`))}
            </div>
          </div>
      ...
      <!-- COMPONENTS -->
      ${this.resolvedSpec.components&&"true"===this.showComponents&&"focused"===this.renderStyle?G`
          <div id='link-components' class='nav-bar-section components'>
            <div></div>
            <div class='nav-bar-section-title'>COMPONENTS</div>
          </div>
          ${this.resolvedSpec.components.map((e=>e.subComponents.length?G`
              ...
              ${e.subComponents.filter((e=>!1!==e.expanded)).map((e=>G`
...
`}function UR(e){const t=new Ke.Renderer;return t.heading=(t,r,s,n)=>`<h${r} class="observe-me" id="${e}--${n.slug(s)}">${t}</h${r}>`,t}function zR(e){return G`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function HR(){var e;if("true"===this.showInfo)return zR(RR.call(this));const t=this.resolvedSpec.tags[0],r=null===(e=this.resolvedSpec.tags[0])||void 0===e?void 0:e.paths[0];return zR(t&&r?jR.call(this,r,t.name):"")}function VR(e){return G`
    <h1 id="${e.elementId}">${e.displayName||e.name}</h1>
    ${"show-description"===this.onNavTagClick&&e.description?G`
        <div class="m-markdown">
          ${I_(`\n            <div class="m-markdown regular-font">\n              ${Ke(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:UR(e.elementId)}:void 0)}\n            </div>`)}
        </div>`:""}
  `}function WR(){if(!this.focusedElementId||!this.resolvedSpec)return;const e=this.focusedElementId;let t,r=null,s=null,n=0;if(e.startsWith("overview")&&"true"===this.showInfo)t=RR.call(this);else if("auth"===e&&"true"===this.allowAuthentication)t=K_.call(this);else if("servers"===e&&"true"===this.allowServerSelection)t=DR.call(this);else if("operations-top"===e)t=G`
    <div id="operations-top" class="observe-me">
      <slot name="operations-top"></slot>
    </div>`;else if(e.startsWith("cmp--")&&"true"===this.showComponents)t=IR.call(this);else if(e.startsWith("tag--")){const r=e.indexOf("--",4)>0?e.substring(0,e.indexOf("--",5)):e;s=this.resolvedSpec.tags.find((e=>e.elementId===r)),t=s?zR.call(this,VR.call(this,s)):HR.call(this)}else{for(n=0;n<this.resolvedSpec.tags.length&&(s=this.resolvedSpec.tags[n],r=this.resolvedSpec.tags[n].paths.find((t=>`${t.elementId}`===e)),!r);n+=1);r?(BR(this.shadowRoot.getElementById(`link-${e}`),"expand"),t=zR.call(this,jR.call(this,r,s.name||"",s.description||""))):t=HR.call(this)}return t}function GR(e){if(e.expanded)e.expanded=!1,"true"===this.updateRoute&&this.replaceHistoryState("");else if(e.expanded=!0,"true"===this.updateRoute){const t=`${this.routePrefix||"#"}${e.elementId}`;window.location.hash!==t&&this.replaceHistoryState(e.elementId)}this.requestUpdate()}function JR(e,t="expand-all"){const r=[...e.querySelectorAll(".section-tag")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}function KR(e,t="expand-all"){JR.call(this,e.target.closest(".operations-root"),t)}function YR(e,t=!1){return G`
  <summary @click="${t=>{GR.call(this,e,t)}}" part="section-endpoint-head-${e.expanded?"expanded":"collapsed"}" class='endpoint-head ${e.method} ${e.deprecated?"deprecated":""} ${t||e.expanded?"expanded":"collapsed"}'>
    ...
    <div  part="section-endpoint-head-path" class="path ${e.deprecated?"deprecated":""}">
      ${e.path}
      ${e.isWebhook?G`<span style="font-family: var(--font-regular); font-size: var(--); font-size: var(--font-size-small); color:var(--primary-color); margin-left: 16px"> Webhook</span>`:""}
    </div>
    ${e.deprecated?G`
  ...
  `}function XR(e){var t,r,s,n,i,o,a,l;const c=new Set;for(const t in e.responses)for(const r in null===(p=e.responses[t])||void 0===p?void 0:p.content){var p;c.add(r.trim())}const u=[...c].join(", "),d=this.resolvedSpec.securitySchemes.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))}))||[],h=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===ct&&"-"!==e.value));h&&d.push(h);const m=e.xCodeSamples?X_(e.xCodeSamples):"";return G`
  <div part="section-endpoint-body-${e.expanded?"expanded":"collapsed"}" class='endpoint-body ${e.method} ${e.deprecated?"deprecated":""}'>
    <div class="summary">
      ${e.summary?G`<div class="title" part="section-endpoint-body-title">${e.summary}</div>`:e.shortSummary!==e.description?G`<div class="title" part="section-endpoint-body-title">${e.shortSummary}</div>`:""}
      ${e.xBadges&&(null===(t=e.xBadges)||void 0===t?void 0:t.length)>0?G`
          <div style="display:flex; flex-wrap:wrap;font-size: var(--font-size-small);">
            ${e.xBadges.map((e=>"none"===e.color?"":G`<span part="endpoint-badge" style="margin:1px; margin-right:5px; padding:1px 8px; font-weight:bold; border-radius:12px;  background-color: var(--light-${e.color}, var(--input-bg)); color:var(--${e.color}); border:1px solid var(--${e.color})">${e.label}</span>`))}
          </div>
          `:""}

      ${e.description?G`<div part="section-endpoint-body-description" class="m-markdown"> ${I_(Ke(e.description))}</div>`:""}
      ${null!==(r=e.externalDocs)&&void 0!==r&&r.url||null!==(s=e.externalDocs)&&void 0!==s&&s.description?G`<div style="background-color:var(--bg3); padding:2px 8px 8px 8px; margin:8px 0; border-radius:var(--border-radius)">
            <div class="m-markdown"> ${I_(Ke((null===(n=e.externalDocs)||void 0===n?void 0:n.description)||""))} </div>
            ${null!==(i=e.externalDocs)&&void 0!==i&&i.url?G`<a style="font-family:var(--font-mono); font-size:var(--font-size-small)" href="${null===(o=e.externalDocs)||void 0===o?void 0:o.url}" target="_blank">
  ...
  </div>`}function ZR(e=!1,t=!1){return this.resolvedSpec?G`
    ${e?"":G`
        <div style="display:flex; justify-content:flex-end;">
          <span @click="${e=>KR(e,"expand-all")}" style="color:var(--primary-color); cursor:pointer;">
            Expand all
          </span>
          &nbsp;|&nbsp;
          <span @click="${e=>KR(e,"collapse-all")}" style="color:var(--primary-color); cursor:pointer;" >
            Collapse all
          </span>
          &nbsp; sections
        </div>`}
    ${this.resolvedSpec.tags.map((r=>G`
      ${e?G`
          <div class='section-tag-body'>
          ${r.paths.filter((e=>!this.searchVal||dt(this.searchVal,e,r.name))).map((e=>G`
            <section id='${e.elementId}' class='m-endpoint regular-font ${e.method} ${t||e.expanded?"expanded":"collapsed"}'>
              ${YR.call(this,e,t)}
              ${t||e.expanded?XR.call(this,e):""}
            </section>`))}
          </div>
        `:G`
  ...
  <header class="row main-header regular-font" part="section-header" style="padding:8px 4px 8px 4px;min-height:48px;">
    <div class="only-large-screen-flex" style="align-items: center;">
      <slot name="logo" class="logo" part="section-logo">
        ${"height:36px;width:36px;margin-left:5px",G`
...
`}
    ...
    <div style="margin: 0px 8px;display:flex;flex:1">
      ${"false"===this.allowSpecUrlLoad?"":G`
          ...
          <div style="margin: 6px 5px 0 -24px; font-size:var(--font-size-regular); cursor:pointer;">&#x21a9;</div>
        `}
      ${"false"===this.allowSpecFileLoad?"":G`
          <input id="spec-file"
            part = "file-input"
            type="file"
            style="display:none"
      ...
      ${"false"===this.allowSearch||"read focused".includes(this.renderStyle)?"":G`
      ...
      ${"false"===this.allowAdvancedSearch||"read focused".includes(this.renderStyle)?"":G`
    ...
    </header>`}customElements.define("schema-tree",class extends ue{static get properties(){return{data:{type:Object},schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},schemaHideWriteOnly:{type:String,attribute:"schema-hide-write-only"}}}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[Ze,kR,oR,c`
      .tree {
        font-size:var(--font-size-small);
        text-align: left;
        direction: ltr;
      ...
      <div class="tree ${"true"===this.schemaDescriptionExpanded?"expanded-all-descr":"collapsed-all-descr"}" @click="${e=>this.handleAllEvents(e)}">
        <div class="toolbar">
          ...
          ${"true"===this.allowSchemaDescriptionExpandToggle?G`
              <div style="flex:1"></div>
        ...
        <span part="schema-description" class='m-markdown'> ${I_(Ke((null===(r=this.data)||void 0===r?void 0:r["::description"])||""))}</span>
        ${this.data?G`
            ${this.generateTree("array"===this.data["::type"]?this.data["::props"]:this.data,this.data["::type"],this.data["::array-type"]||"")}`:G`<span class='mono-font' style='color:var(--red)'> Schema not found </span>`}
      </div>
    `}generateTree(e,t="object",r="",s="",n="",i=0,o=0,a="",l=!1){var c;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===a)return;if("readonly"===(null==e?void 0:e["::readwrite"]))return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===a)return;if("writeonly"===(null==e?void 0:e["::readwrite"]))return}if(!e)return G`<div class="null" style="display:inline;">
        <span class="key-label xxx-of-key"> ${s.replace("::OPTION~","")}</span>
        ${"array"===t?G`<span class='mono-font'> [ ] </span>`:"object"===t?G`<span class='mono-font'> { } </span>`:G`<span class='mono-font'> schema undefined </span>`}
      </div>`;if(0===Object.keys(e).length)return G`<span class="key object">${s}:{ }</span>`;let p="",u="";if(s.startsWith("::ONE~OF")||s.startsWith("::ANY~OF"))p=s.replace("::","").replace("~"," ");else if(s.startsWith("::OPTION")){const e=s.split("~");[,p,u]=e}else p=s;const d=400-12*o;let h="",m="";const f=null!==(c=e["::type"])&&void 0!==c&&c.startsWith("xxx-of")?i:i+1,g="xxx-of-option"===t||"xxx-of-option"===e["::type"]||s.startsWith("::OPTION")?o:o+1;if("object"===e["::type"])"array"===t?(h=i<this.schemaExpandLevel?G`<span class="open-bracket array-of-object" >[{</span>`:G`<span class="open-bracket array-of-object">[{...}]</span>`,m="}]"):(h=i<this.schemaExpandLevel?G`<span class="open-bracket object">${e["::nullable"]?"null┃":""}{</span>`:G`<span class="open-bracket object">${e["::nullable"]?"null┃":""}{...}</span>`,m="}");else if("array"===e["::type"])if("array"===t){const e="object"!==r?r:"";h=i<this.schemaExpandLevel?G`<span class="open-bracket array-of-array" data-array-type="${e}">[[ ${e} </span>`:G`<span class="open-bracket array-of-array"  data-array-type="${e}">[[...]]</span>`,m="]]"}else h=i<this.schemaExpandLevel?G`<span class="open-bracket array">[</span>`:G`<span class="open-bracket array">[...]</span>`,m="]";var y;if("object"==typeof e)return G`
        <div class="tr ${i<this.schemaExpandLevel||null!==(y=e["::type"])&&void 0!==y&&y.startsWith("xxx-of")?"expanded":"collapsed"} ${e["::type"]||"no-type-info"}${e["::nullable"]?" nullable":""}" title="${l||e["::deprecated"]?"Deprecated":""}">
          <div class="td key ${l||e["::deprecated"]?"deprecated":""}" style='min-width:${d}px'>
            ${"xxx-of-option"===e["::type"]||"xxx-of-array"===e["::type"]||s.startsWith("::OPTION")?G`<span class='key-label xxx-of-key'> ${p}</span><span class="xxx-of-descr">${u}</span>`:"::props"===p||"::ARRAY~OF"===p?"":i>0?G`<span class="key-label" title="${"readonly"===a?"Read-Only":"writeonly"===a?"Write-Only":""}">
                      ${l||e["::deprecated"]?G`<svg viewBox="0 0 10 10" width="10" height="10" style="stroke:var(--red); margin-right:-6px"><path d="M2 2L8 8M2 8L8 2"/></svg>`:""}
                      ${p.replace(/\*$/,"")}${p.endsWith("*")?G`<span style="color:var(--red)">*</span>`:""}${"readonly"===a?G` 🆁`:"writeonly"===a?G` 🆆`:a}:
                    </span>`:""}
            ${h}
          </div>
          <div class='td key-descr m-markdown-small'>${I_(Ke(n||""))}</div>
        </div>
        <div class='inside-bracket ${e["::type"]||"no-type-info"}' style='padding-left:${"xxx-of-option"===e["::type"]||"xxx-of-array"===e["::type"]?0:12}px;'>
          ${Array.isArray(e)&&e[0]?G`${this.generateTree(e[0],"xxx-of-option","","::ARRAY~OF","",f,g,e[0]["::readwrite"],l||e[0]["::deprecated"])}`:G`
              ${Object.keys(e).map((t=>{var r;return G`
                ${["::title","::description","::type","::props","::deprecated","::array-type","::readwrite","::dataTypeLabel","::nullable"].includes(t)?"array"===e[t]["::type"]||"object"===e[t]["::type"]?G`${this.generateTree("array"===e[t]["::type"]?e[t]["::props"]:e[t],e[t]["::type"],e[t]["::array-type"]||"",t,e[t]["::description"],f,g,e[t]["::readwrite"]?e[t]["::readwrite"]:"",l||e[t]["::deprecated"])}`:"":G`${this.generateTree("array"===e[t]["::type"]?e[t]["::props"]:e[t],e[t]["::type"],e[t]["::array-type"]||"",t,(null===(r=e[t])||void 0===r?void 0:r["::description"])||"",f,g,e[t]["::readwrite"]?e[t]["::readwrite"]:"",l||e[t]["::deprecated"])}`}
              `}))}
            `}
        </div>
        ${e["::type"]&&e["::type"].includes("xxx-of")?"":G`<div class='close-bracket'> ${m} </div>`}
      `;const[v,b,x,w,$,S,E,k,A]=e.split("~|~");if("🆁"===b&&"true"===this.schemaHideReadOnly)return;if("🆆"===b&&"true"===this.schemaHideWriteOnly)return;const O=v.replace(/┃.*/g,"").replace(/[^a-zA-Z0-9+]/g,"").substring(0,4).toLowerCase(),j=x||w||$||S?`<span class="descr-expand-toggle ${"true"===this.schemaDescriptionExpanded?"expanded-descr":""}">➔</span>`:"";let T="",P="";return"array"===t?"readonly"===a?(T="🆁",P="Read-Only"):"writeonly"===a&&(T="🆆",P="Write-Only"):"🆁"===b?(T="🆁",P="Read-Only"):"🆆"===b&&(T="🆆",P="Write-Only"),G`
      <div class = "tr primitive" title="${A?"Deprecated":""}">
        <div class="td key ${l||A}" style='min-width:${d}px'>
          ${l||A?G`<svg viewBox="0 0 10 10" width="10" height="10" style="stroke:var(--red); margin-right:-6px"><path d="M2 2L8 8M2 8L8 2"/></svg>`:""}
          ${p.endsWith("*")?G`<span class="key-label">${p.substring(0,p.length-1)}</span><span style='color:var(--red);'>*</span>:`:s.startsWith("::OPTION")?G`<span class='key-label xxx-of-key'>${p}</span><span class="xxx-of-descr">${u}</span>`:G`<span class="key-label">${p}:</span>`}
    ...
    <div class="col regular-font request-panel ${"read focused".includes(this.renderStyle)||"true"===this.callback?"read-mode":"view-mode"}">
      ...
      <div>
        ${eR([this.method,this.path,this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("path")))}
        ${eR([this.method,this.path,this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("query")))}
        ${this.requestBodyTemplate()}
        ${eR([this.method,this.path,this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("header")))}
        ${eR([this.method,this.path,this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("cookie")))}
        ${"false"===this.allowTry?"":G`${this.apiCallTemplate()}`}
      </div>
    </div>
    `}async updated(){"true"===this.showCurlBeforeTry&&this.applyCURLSyntax(this.shadowRoot),"true"===this.webhook&&(this.allowTry="false")}async saveExampleState(){"focused"===this.renderStyle&&([...this.shadowRoot.querySelectorAll("textarea.request-body-param-user-input")].forEach((e=>{e.dataset.user_example=e.value})),[...this.shadowRoot.querySelectorAll('textarea[data-ptype="form-data"]')].forEach((e=>{e.dataset.user_example=e.value})),this.requestUpdate())}async updateExamplesFromDataAttr(){"focused"===this.renderStyle&&([...this.shadowRoot.querySelectorAll("textarea.request-body-param-user-input")].forEach((e=>{e.value=e.dataset.user_example||e.dataset.example})),[...this.shadowRoot.querySelectorAll('textarea[data-ptype="form-data"]')].forEach((e=>{e.value=e.dataset.user_example||e.dataset.example})),this.requestUpdate())}renderExample(e,t,r){var s,n;return G`
      ...
      ${"array"===t?"] ":""}
    `}renderShortFormatExamples(e,t,r){return G`${e.map(((e,s)=>G`
      ${0===s?"":"┃"}
      ${this.renderExample(e,t,r)}`))}`}renderLongFormatExamples(e,t,r){return G` <ul style="list-style-type: disclosure-closed;">
      ${e.map((e=>{var s,n;return G`
          <li>
            ${this.renderExample(e,t,r)}
            ${(null===(s=e.summary)||void 0===s?void 0:s.length)>0?G`<span>&lpar;${e.summary}&rpar;</span>`:""}
            ${(null===(n=e.description)||void 0===n?void 0:n.length)>0?G`<p>${I_(Ke(e.description))}</p>`:""}
          </li>
        `}))}
    </ul>`}exampleListTemplate(e,t,r=[]){return G` ${r.length>0?G`<span style="font-weight:bold">Examples: </span>
          ${s=r,s.some((e=>{var t,r;return(null===(t=e.summary)||void 0===t?void 0:t.length)>0||(null===(r=e.description)||void 0===r?void 0:r.length)>0}))?this.renderLongFormatExamples(r,t,e):this.renderShortFormatExamples(r,t,e)}`:""}`;var s}inputParametersTemplate(e){const t=this.parameters?this.parameters.filter((t=>t.in===e)):[];if(0===t.length)return"";let r="";"path"===e?r="PATH PARAMETERS":"query"===e?r="QUERY-STRING PARAMETERS":"header"===e?r="REQUEST HEADERS":"cookie"===e&&(r="COOKIES");const s=[];for(const r of t){const[t,n,i]=ER(r);if(!t)continue;const o=pR(t);if(!o)continue;const a=wR(t,{});let l="form",c=!0,p=!1;"query"!==e&&"header"!==e&&"path"!==e||(r.style&&"form spaceDelimited pipeDelimited".includes(r.style)?l=r.style:n&&(l=n),"boolean"==typeof r.explode&&(c=r.explode),"boolean"==typeof r.allowReserved&&(p=r.allowReserved));const u=dR(uR(r.examples)||uR(r.example)||uR(null==i?void 0:i.example)||uR(null==i?void 0:i.examples)||uR(o.examples)||uR(o.example),o.type);u.exampleVal||"object"!==o.type||(u.exampleVal=$R(t,n||"json",{},{},"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,!0,"text")[0].exampleValue);const d="read focused".includes(this.renderStyle)?"200px":"160px";s.push(G`
      <tr title="${r.deprecated?"Deprecated":""}">
        <td rowspan="${"true"===this.allowTry?"1":"2"}" style="width:${d}; min-width:100px;">
          <div class="param-name ${r.deprecated?"deprecated":""}" >
            ${r.deprecated?G`<svg viewBox="0 0 10 10" width="10" height="10" style="stroke:var(--red); margin-right:-6px"><path d="M2 2L8 8M2 8L8 2"/></svg>`:""}
            ${r.required?G`<span style='color:var(--red)'>*</span>`:""}
            ${r.name}
          </div>
            ...
            <td style="min-width:100px;" colspan="${o.default||o.constrain||o.allowedValues||o.pattern?"1":"2"}">
              ${"array"===o.type?G`
                  <tag-input class="request-param"
                    ...
                    .value="${"no"===r["x-fill-example"]?[]:sR("true"===this.fillRequestFieldsWithExample?Array.isArray(u.exampleVal)?u.exampleVal:[u.exampleVal]:[])}"
                  >
                  </tag-input>`:"object"===o.type?G`
                    ...
                    ${G`<div part="tab-content" class="tab-content col" data-tab = 'example' style="display:${"example"===this.activeParameterSchemaTabs[r.name]?"block":"none"}; padding-left:5px; width:100%">
                        <textarea
                          ...
                          data-x-fill-example = "${r["x-fill-example"]||"yes"}"
                          spellcheck = "false"
                          .textContent="${"no"===r["x-fill-example"]?"":sR("true"===this.fillRequestFieldsWithExample?"object"==typeof u.exampleVal?JSON.stringify(u.exampleVal,null,2):u.exampleVal:"")}"
                          style = "resize:vertical; width:100%; height: ${"read focused".includes(this.renderStyle)?"180px":"120px"};"
                          @input=${e=>{const t=this.getRequestPanel(e);this.liveCURLSyntaxUpdate(t)}}
                        ></textarea>
                      </div>`}
                    ${G`<div part="tab-content" class="tab-content col" data-tab = 'schema' style="display:${"example"!==this.activeParameterSchemaTabs[r.name]?"block":"none"}; padding-left:5px; width:100%;">
                        <schema-tree
                          class = 'json'
                          style = 'display: block'
                          .data = '${a}'
                    ...
                    <input type="${"password"===o.format?"password":"text"}" spellcheck="false" style="width:100%"
                      ...
                      data-x-fill-example = "${r["x-fill-example"]||"yes"}"
                      data-array="false"
                      .value="${"no"===r["x-fill-example"]?"":sR("true"===this.fillRequestFieldsWithExample?u.exampleVal:"")}"
                      @input=${e=>{const t=this.getRequestPanel(e);this.liveCURLSyntaxUpdate(t)}}
                    />`}
            </td>`:""}
        ${o.default||o.constrain||o.allowedValues||o.pattern?G`
            <td colspan="${"true"===this.allowTry?"1":"2"}">
              <div class="param-constraint">
                ${o.default?G`<span style="font-weight:bold">Default: </span>${o.default}<br/>`:""}
                ${o.pattern?G`<span style="font-weight:bold">Pattern: </span>${o.pattern}<br/>`:""}
                ${o.constrain?G`${o.constrain}<br/>`:""}
                ${o.allowedValues&&o.allowedValues.split("┃").map(((e,t)=>G`
                  ${t>0?"┃":G`<span style="font-weight:bold">Allowed: </span>`}
                  ${G`
      ...
      <tr>
        ${"true"===this.allowTry?G`<td style="border:none"> </td>`:""}
        <td colspan="2" style="border:none">
          <span class="m-markdown-small">${I_(Ke(r.description||""))}</span>
    ...
    <div style="display:block; overflow-x:auto; max-width:100%;">
      ...
      `,i.forEach((e=>{let i,o=[];if(this.selectedRequestBodyType.includes("json")||this.selectedRequestBodyType.includes("xml")||this.selectedRequestBodyType.includes("text")||this.selectedRequestBodyType.includes("jose"))e.mimeType===this.selectedRequestBodyType&&(o=$R(e.schema,e.mimeType,uR(e.examples),uR(e.example),"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1),this.selectedRequestBodyExample||(this.selectedRequestBodyExample=o.length>0?o[0].exampleId:""),n=G`
            ${n}
            <div class = 'example-panel border-top pad-top-8'>
              ${1===o.length?"":G`
                  <select style="min-width:100px; max-width:100%;  margin-bottom:-1px;" @change='${e=>this.onSelectExample(e)}'>
                    ${o.map((e=>G`<option value="${e.exampleId}" ?selected=${e.exampleId===this.selectedRequestBodyExample} >
                      ${e.exampleSummary.length>80?e.exampleId:e.exampleSummary?e.exampleSummary:e.exampleId}
                    </option>`))}
                  </select>
                `}
              ${o.filter((e=>e.exampleId===this.selectedRequestBodyExample)).map((t=>G`
                <div class="example ${t.exampleId===this.selectedRequestBodyExample?"example-selected":""}" data-example = '${t.exampleId}'>
                  ${t.exampleSummary&&t.exampleSummary.length>80?G`<div style="padding: 4px 0"> ${t.exampleSummary} </div>`:""}
                  ${t.exampleDescription?G`<div class="m-markdown-small" style="padding: 4px 0"> ${I_(Ke(t.exampleDescription||""))} </div>`:""}
          ...
          `);else if(this.selectedRequestBodyType.includes("form-urlencoded")||this.selectedRequestBodyType.includes("form-data")){if(e.mimeType===this.selectedRequestBodyType){const t=$R(e.schema,e.mimeType,e.examples,e.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1);e.schema&&(r=this.formDataTemplate(e.schema,e.mimeType,t[0]?t[0].exampleValue:""))}}else/^audio\/|^image\/|^video\/|^font\/|tar$|zip$|7z$|rtf$|msword$|excel$|\/pdf$|\/octet-stream$/.test(this.selectedRequestBodyType)&&e.mimeType===this.selectedRequestBodyType&&(t=G`
          ...
          `);(e.mimeType.includes("json")||e.mimeType.includes("xml")||e.mimeType.includes("text")||this.selectedRequestBodyType.includes("jose"))&&(i=wR(e.schema,{}),"table"===this.schemaStyle?s=G`
            ${s}
            <schema-table
      ...
      <div class='request-body-container' data-selected-request-body-type="${this.selectedRequestBodyType}">
        ...
        ${this.request_body.description?G`<div class="m-markdown" style="margin-bottom:12px">${I_(Ke(this.request_body.description))}</div>`:""}
        ...
        ${this.selectedRequestBodyType.includes("json")||this.selectedRequestBodyType.includes("xml")||this.selectedRequestBodyType.includes("text")||this.selectedRequestBodyType.includes("jose")?G`
            <div part="tab-panel" class="tab-panel col" style="border-width:0 0 1px 0;">
              ...
              ${G`<div part="tab-content" class="tab-content col" style="display:${"example"===this.activeSchemaTab?"block":"none"};"> ${n}</div>`}
              ${G`<div part="tab-content" class="tab-content col" style="display:${"example"===this.activeSchemaTab?"none":"block"};"> ${s}</div>`}
            </div>`:G`
            ${t}
            ${r}`}
      </div>
    `}formDataParamAsObjectTemplate(e,t,r){var s;const n=wR(t,{}),i=$R(t,"json",uR(t.examples),uR(t.example),"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1);return G`
    ...
    `}formDataTemplate(e,t,r=""){const s=[];if(e.properties){for(const r in e.properties){var n,i;const o=e.properties[r];if(o.readOnly)continue;const a=o.examples||o.example||"",l=o.type,c=pR(o),p="read focused".includes(this.renderStyle)?"200px":"160px",u=dR(c.examples||c.example,c.type);s.push(G`
        <tr title="${o.deprecated?"Deprecated":""}">
          <td style="width:${p}; min-width:100px;">
            <div class="param-name ${o.deprecated?"deprecated":""}">
              ${r}${null!==(n=e.required)&&void 0!==n&&n.includes(r)||o.required?G`<span style='color:var(--red);'>*</span>`:""}
            </div>
          ...
          <td
            ...
            ${"array"===l?"binary"===(null===(i=o.items)||void 0===i?void 0:i.format)?G`
                ...
                `:G`
                ${"object"===l?this.formDataParamAsObjectTemplate.call(this,r,o,t):G`
                    ${"true"===this.allowTry?G`<input
              ...
              <td>
                ${c.default||c.constrain||c.allowedValues||c.pattern?G`
                    <div class="param-constraint">
                      ...
                      ${c.allowedValues&&c.allowedValues.split("┃").map(((e,t)=>G`
                        ${t>0?"┃":G`<span style="font-weight:bold">Allowed: </span>`}
                        ${G`
                          <a part="anchor anchor-param-constraint" class = "${"true"===this.allowTry?"":"inactive-link"}"
        ...
        ${"object"===l?"":G`
            <tr>
              ...
              <td colspan="2" style="border:none; margin-top:0; padding:0 5px 8px 5px;">
                <span class="m-markdown-small">${I_(Ke(o.description||""))}</span>
      ...
      <textarea
        ...
        style="width:100%"
      ></textarea>
      ${e.description?G`<span class="m-markdown-small">${I_(Ke(e.description))}</span>`:""}
    `}curlSyntaxTemplate(e="flex"){return G`
      <div class="col m-markdown" style="flex:1; display:${e}; position:relative; max-width: 100%;">
        <button  class="toolbar-btn" style = "position:absolute; top:12px; right:8px" @click='${e=>{ut(this.curlSyntax.trim().replace(/\\$/,""),e)}}' part="btn btn-fill"> Copy </button>
        <pre style="white-space:pre"><code>${I_(Xe().highlight(this.curlSyntax.trim().replace(/\\$/,""),Xe().languages.shell,"shell"))}</code></pre>
      </div>
      `}apiResponseTabTemplate(){let e="",t="";if(!this.responseIsBlob)if(this.responseHeaders.includes("application/x-ndjson")){e="json";const r=this.responseText.split("\n").map((t=>Xe().highlight(t,Xe().languages[e],e))).join("\n");t=G`<code>${I_(r)}</code>`}else this.responseHeaders.includes("json")?(e="json",t=G`<code>${I_(Xe().highlight(this.responseText,Xe().languages[e],e))}</code>`):this.responseHeaders.includes("html")||this.responseHeaders.includes("xml")?(e="html",t=G`<code>${I_(Xe().highlight(this.responseText,Xe().languages[e],e))}</code>`):(e="text",t=G`<code>${this.responseText}</code>`);return G`
      ...
      <div part="tab-panel" class="tab-panel col" style="border-width:0 0 1px 0;">
        <div id="tab_buttons" part="tab-btn-row" class="tab-buttons row" @click="${e=>{!1!==e.target.classList.contains("tab-btn")&&(this.activeResponseTab=e.target.dataset.tab)}}">
          ...
          ${"true"===this.showCurlBeforeTry?"":G`<button part="tab-btn" class="tab-btn ${"curl"===this.activeResponseTab?"active":""}" data-tab = 'curl'>CURL</button>`}
        </div>
        ${this.responseIsBlob?G`
            <div part="tab-content" class="tab-content col" style="flex:1; display:${"response"===this.activeResponseTab?"flex":"none"};">
              ${"image"===this.responseBlobType?G`<img style="max-height:var(--resp-area-height, 400px); object-fit:contain;" class="mar-top-8" src="${(e=>this.responseBlobUrl??K)()}"></img>`:""}
              <button class="m-btn thin-border mar-top-8" style="width:135px" @click='${e=>{mt(this.responseBlobUrl,this.respContentDisposition)}}' part="btn btn-outline">
                DOWNLOAD
              </button>
              ${"view"===this.responseBlobType||"image"===this.responseBlobType?G`<button class="m-btn thin-border mar-top-8" style="width:135px"  @click='${e=>{ft(this.responseBlobUrl)}}' part="btn btn-outline">VIEW (NEW TAB)</button>`:""}
            </div>`:G`
            <div part="tab-content" class="tab-content col m-markdown" style="flex:1; display:${"response"===this.activeResponseTab?"flex":"none"};" >
              <button class="toolbar-btn" style="position:absolute; top:12px; right:8px" @click='${e=>{ut(this.responseText,e)}}' part="btn btn-fill"> Copy </button>
        ...
        <div part="tab-content" class="tab-content col m-markdown" style="flex:1; display:${"headers"===this.activeResponseTab?"flex":"none"};" >
          <button  class="toolbar-btn" style = "position:absolute; top:12px; right:8px" @click='${e=>{ut(this.responseHeaders,e)}}' part="btn btn-fill"> Copy </button>
          <pre style="white-space:pre"><code>${I_(Xe().highlight(this.responseHeaders,Xe().languages.css,"css"))}</code></pre>
        </div>
        ${"true"===this.showCurlBeforeTry?"":this.curlSyntaxTemplate("curl"===this.activeResponseTab?"flex":"none")}
      </div>`}apiCallTemplate(){var e,t;const r=G`
    ...
    <div style="display:flex; align-items:flex-end; margin:16px 0; font-size:var(--font-size-small);" part="wrap-request-btn">
      <div class="hide-in-small-screen" style="flex-direction:column; margin:0; width:calc(100% - 60px);">
        ...
        <div style="display:flex;">
          ...
          ${(null===(e=this.security)||void 0===e?void 0:e.length)>0?G`
    ...
    `}generateTree(e,t="object",r="",s="",n="",i=0,o=0,a="",l=!1){var c,p;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===a)return;if(e&&"readonly"===e["::readwrite"])return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===a)return;if(e&&"writeonly"===e["::readwrite"])return}if(!e)return G`<div class="null" style="display:inline;">
        <span style='margin-left:${16*(i+1)}px'> &nbsp; </span>
        <span class="key-label xxx-of-key"> ${s.replace("::OPTION~","")}</span>
        ${"array"===t?G`<span class='mono-font'> [ ] </span>`:"object"===t?G`<span class='mono-font'> { } </span>`:G`<span class='mono-font'> schema undefined </span>`}
      </div>`;const u=null!==(c=e["::type"])&&void 0!==c&&c.startsWith("xxx-of")?i:i+1,d="xxx-of-option"===t||"xxx-of-option"===e["::type"]||s.startsWith("::OPTION")?o:o+1,h=16*d;if(0===Object.keys(e).length)return G`<span class="td key object" style='padding-left:${h}px'>${s}</span>`;let m="",f="",g=!1;if(s.startsWith("::ONE~OF")||s.startsWith("::ANY~OF"))m=s.replace("::","").replace("~"," "),g=!0;else if(s.startsWith("::OPTION")){const e=s.split("~");m=e[1],f=e[2]}else m=s;let y="";if("object"===e["::type"]?y="array"===t?"array of object":e["::dataTypeLabel"]||e["::type"]:"array"===e["::type"]&&(y="array"===t?"array of array "+("object"!==r?`of ${r}`:""):e["::dataTypeLabel"]||e["::type"]),"object"==typeof e)return G`
        ${u>=0&&s?G`
            <div class='tr ${u<=this.schemaExpandLevel?"expanded":"collapsed"} ${e["::type"]}' data-obj='${m}' title="${l||e["::deprecated"]?"Deprecated":""}">
              <div class="td key ${l||e["::deprecated"]?"deprecated":""}" style='padding-left:${h}px'>
                ...
                ${"xxx-of-option"===e["::type"]||"xxx-of-array"===e["::type"]||s.startsWith("::OPTION")?G`<span class="xxx-of-key" style="margin-left:-6px">${m}</span><span class="${g?"xxx-of-key":"xxx-of-descr"}">${f}</span>`:m.endsWith("*")?G`<span class="key-label" style="display:inline-block; margin-left:-6px;">${l||e["::deprecated"]?G`<svg viewBox="0 0 10 10" width="10" height="10" style="stroke:var(--red); margin-right:-6px"><path d="M2 2L8 8M2 8L8 2"/></svg>`:""} ${m.substring(0,m.length-1)}</span><span style='color:var(--red);'>*</span>`:G`<span class="key-label" style="display:inline-block; margin-left:-6px;">${l||e["::deprecated"]?G`<svg viewBox="0 0 10 10" width="10" height="10" style="stroke:var(--red); margin-right:-6px"><path d="M2 2L8 8M2 8L8 2"/></svg>`:""} ${"::props"===m?"":m}</span>`}
                ${"xxx-of"===e["::type"]&&"array"===t?G`<span style="color:var(--primary-color)">ARRAY</span>`:""}
              </div>
              ...
              <div class='td key-descr m-markdown-small' style='line-height:1.7'>${I_(Ke(n||""))}</div>
            </div>`:G`
            ${"array"===e["::type"]&&"array"===t?G`
                <div class='tr'>
        ...
        ${Array.isArray(e)&&e[0]?G`${this.generateTree(e[0],"xxx-of-option","","::ARRAY~OF","",u,d,"")}`:G`
            ${Object.keys(e).map((t=>{var r;return G`
              ${["::title","::description","::type","::props","::deprecated","::array-type","::readwrite","::dataTypeLabel","::nullable"].includes(t)?"array"===e[t]["::type"]||"object"===e[t]["::type"]?G`${this.generateTree("array"===e[t]["::type"]?e[t]["::props"]:e[t],e[t]["::type"],e[t]["::array-type"]||"",t,e[t]["::description"],u,d,e[t]["::readwrite"]?e[t]["::readwrite"]:"",l||e[t]["::deprecated"])}`:"":G`${this.generateTree("array"===e[t]["::type"]?e[t]["::props"]:e[t],e[t]["::type"],e[t]["::array-type"]||"",t,(null===(r=e[t])||void 0===r?void 0:r["::description"])||"",u,d,e[t]["::readwrite"]?e[t]["::readwrite"]:"",l||e[t]["::deprecated"])}`}
            `}))}
          `}
        </div>
      `;const[v,b,x,w,$,S,E,k,A]=e.split("~|~");if("🆁"===b&&"true"===this.schemaHideReadOnly)return;if("🆆"===b&&"true"===this.schemaHideWriteOnly)return;const O=v.replace(/┃.*/g,"").replace(/[^a-zA-Z0-9+]/g,"").substring(0,4).toLowerCase(),j=x||w||$||S?'<span class="descr-expand-toggle">➔</span>':"";let T="";return T="array"===t?G`
      ...
      <div class = "tr primitive" title="${l||A?"Deprecated":""}">
        <div class="td key ${l||A?"deprecated":""}" style='padding-left:${h}px'>
          ${l||A?G`<svg viewBox="0 0 10 10" width="10" height="10" style="stroke:var(--red); margin-right:-6px"><path d="M2 2L8 8M2 8L8 2"/></svg>`:""}
          ${null!==(p=m)&&void 0!==p&&p.endsWith("*")?G`
              <span class="key-label">${m.substring(0,m.length-1)}</span>
              <span style='color:var(--red);'>*</span>`:s.startsWith("::OPTION")?G`<span class='xxx-of-key'>${m}</span><span class="xxx-of-descr">${f}</span>`:G`${m?G`<span class="key-label"> ${m}</span>`:G`<span class="xxx-of-descr">${k}</span>`}`}
        </div>
        ${T}
    ...
    `}resetSelection(){this.selectedStatus="",this.selectedMimeType=""}responseTemplate(){if(!this.responses)return"";for(const s in this.responses){this.selectedStatus||(this.selectedStatus=s);const n={};for(const r in null===(e=this.responses[s])||void 0===e?void 0:e.content){var e,t;const i=this.responses[s].content[r];this.selectedMimeType||(this.selectedMimeType=r);const o=wR(i.schema,{}),a=$R(i.schema,r,uR(i.examples),uR(i.example),"true"!==this.callback&&"true"!==this.webhook,"true"===this.callback||"true"===this.webhook,r.includes("json")?"json":"text");n[r]={description:this.responses[s].description,examples:a,selectedExample:(null===(t=a[0])||void 0===t?void 0:t.exampleId)||"",schemaTree:o}}const i=[];for(const e in null===(r=this.responses[s])||void 0===r?void 0:r.headers){var r;i.push({name:e,...this.responses[s].headers[e]})}this.headersForEachRespStatus[s]=i,this.mimeResponsesForEachStatus[s]=n}return G`
      ...
      ${Object.keys(this.responses).map((e=>{var t,r;return G`
        <div style = 'display: ${e===this.selectedStatus?"block":"none"}' >
          <div class="top-gap">
            <span class="resp-descr m-markdown ">${I_(Ke((null===(t=this.responses[e])||void 0===t?void 0:t.description)||""))}</span>
            ${this.headersForEachRespStatus[e]&&(null===(r=this.headersForEachRespStatus[e])||void 0===r?void 0:r.length)>0?G`${this.responseHeaderListTemplate(this.headersForEachRespStatus[e])}`:""}
          </div>
          ${0===Object.keys(this.mimeResponsesForEachStatus[e]).length?"":G`
              <div part="tab-panel" class="tab-panel col">
                <div part="tab-btn-row" class="tab-buttons row" @click="${e=>{"button"===e.target.tagName.toLowerCase()&&(this.activeSchemaTab=e.target.dataset.tab)}}" >
                  <button part="tab-btn" class="tab-btn ${"example"===this.activeSchemaTab?"active":""}" data-tab = 'example'>EXAMPLE </button>
                  <button part="tab-btn" class="tab-btn ${"example"!==this.activeSchemaTab?"active":""}" data-tab = 'schema' >SCHEMA</button>
                  <div style="flex:1"></div>
                  ${1===Object.keys(this.mimeResponsesForEachStatus[e]).length?G`<span class='small-font-size gray-text' style='align-self:center; margin-top:8px;'> ${Object.keys(this.mimeResponsesForEachStatus[e])[0]} </span>`:G`${this.mimeTypeDropdownTemplate(Object.keys(this.mimeResponsesForEachStatus[e]))}`}
                </div>
                ${"example"===this.activeSchemaTab?G`<div part="tab-content" class ='tab-content col' style = 'flex:1;'>
            ...
            `}</div>`}))}
    `}responseHeaderListTemplate(e){return G`
      ...
      <table role="presentation" style="border-collapse: collapse; margin-bottom:16px; border:1px solid var(--border-color); border-radius: var(--border-radius)" class="small-font-size mono-font">
        ${e.map((e=>{var t,r;return G`
          <tr>
            ...
            <td style="padding:8px; vertical-align: baseline; border-top: 1px solid var(--light-border-color);text-overflow: ellipsis;">
              <div class="m-markdown-small regular-font" >${I_(Ke(e.description||""))}</div>
            </td>
            <td style="padding:8px; vertical-align: baseline; border-top: 1px solid var(--light-border-color); text-overflow: ellipsis;">
        ...
        `}))}
    </table>`}mimeTypeDropdownTemplate(e){return G`
      <select aria-label='mime types' @change="${e=>{this.selectedMimeType=e.target.value}}" style='margin-bottom: -1px; z-index:1'>
        ${e.map((e=>G`<option value='${e}' ?selected = '${e===this.selectedMimeType}'> ${e} </option>`))}
      </select>`}onSelectExample(e){[...e.target.closest(".example-panel").querySelectorAll(".example")].forEach((t=>{t.style.display=t.dataset.example===e.target.value?"block":"none"}))}mimeExampleTemplate(e){return e?G`
      ${1===e.examples.length?G`
          ${"json"===e.examples[0].exampleFormat?G`
              ${e.examples[0].exampleSummary&&e.examples[0].exampleSummary.length>80?G`<div style="padding: 4px 0"> ${e.examples[0].exampleSummary} </div>`:""}
              ${e.examples[0].exampleDescription?G`<div class="m-markdown-small" style="padding: 4px 0"> ${I_(Ke(e.examples[0].exampleDescription||""))} </div>`:""}
              <json-tree
                render-style = '${this.renderStyle}'
          ...
          <span class = 'example-panel ${"read"===this.renderStyle?"border pad-8-16":"border-top pad-top-8"}'>
            <select aria-label='response examples' style="min-width:100px; max-width:100%" @change='${e=>this.onSelectExample(e)}'>
              ${e.examples.map((t=>G`<option value="${t.exampleId}" ?selected=${t.exampleId===e.selectedExample} >
            ...
            ${e.examples.map((t=>G`
              <div class="example" data-example = '${t.exampleId}' style = "display: ${t.exampleId===e.selectedExample?"block":"none"}">
                ${t.exampleSummary&&t.exampleSummary.length>80?G`<div style="padding: 4px 0"> ${t.exampleSummary} </div>`:""}
                ${t.exampleDescription?G`<div class="m-markdown-small"  style="padding: 4px 0"> ${I_(Ke(t.exampleDescription||""))} </div>`:""}
                ${"json"===t.exampleFormat?G`
                    <json-tree
                      render-style = '${this.renderStyle}'
                      .data = '${t.exampleValue}'
                      exportparts = "btn:btn, btn-fill:btn-fill, btn-copy:btn-copy"
                    ></json-tree>`:G`<pre>${t.exampleValue}</pre>`}
              </div>
            `))}
          </span>
        `}
    `:G`
      ...
      `}mimeSchemaTemplate(e){return e?G`
      ${"table"===this.schemaStyle?G`
          <schema-table
            .data = "${e.schemaTree}"
            schema-expand-level = "${this.schemaExpandLevel}"
...
`;function tF(){var e;return document.addEventListener("close",(()=>{this.showAdvancedSearchDialog=!1})),document.addEventListener("open",this.onOpenSearchDialog),G`
    <dialog-box
      heading="Search"
    ...
    >
      ...
      ${null===(e=this.advancedSearchMatches)||void 0===e?void 0:e.map((e=>G`
      <div
  ...
  `}customElements.define("dialog-box",class extends ue{static get properties(){return{heading:{type:String,attribute:"heading"},show:{type:String,attribute:"show"}}}static get styles(){return[eF]}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",(e=>{"Escape"===e.code&&this.onClose()}))}attributeChangedCallback(e,t,r){t!==r&&("heading"===e&&(this.heading=r),"show"===e&&(this.show=r,"true"===r&&document.dispatchEvent(new CustomEvent("open",{bubbles:!0,composed:!0,detail:this})))),super.attributeChangedCallback(e,t,r)}render(){return G`
    ${"true"===this.show?G`
        ...
        </div>`:""}`}onClose(){document.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}});const rF={color:{inputReverseFg:"#fff",inputReverseBg:"#333",headerBg:"#444",getRgb(e){if(0===e.indexOf("#")&&(e=e.slice(1,7)),3!==e.length&&4!==e.length||(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),6!==e.length)throw new Error("Invalid HEX color.");return{r:parseInt(e.slice(0,2),16),g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}},luminanace(e){const t=this.getRgb(e);return.299*t.r+.587*t.g+.114*t.b},invert(e){return this.luminanace(e)>135?"#000":"#fff"},opacity(e,t){const r=this.getRgb(e);return`rgba(${r.r}, ${r.g}, ${r.b}, ${t})`},brightness(e,t){const r=this.getRgb(e);return r.r+=t,r.g+=t,r.b+=t,r.r>255?r.r=255:r.r<0&&(r.r=0),r.g>255?r.g=255:r.g<0&&(r.g=0),r.b>255?r.b=255:r.b<0&&(r.b=0),`#${r.r.toString(16).padStart(2,"0")}${r.g.toString(16).padStart(2,"0")}${r.b.toString(16).padStart(2,"0")}`},hasGoodContrast(e,t){return this.luminanace(e)-this.luminanace(t)}}};function sF(e){return/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3}|[A-Fa-f0-9]{8}|[A-Fa-f0-9]{4})$/i.test(e)}function nF(e,t={}){let r={};const s=t.primaryColor?t.primaryColor:"dark"===e?"#f76b39":"#ff591e",n=rF.color.invert(s),i=rF.color.opacity(s,"0.4");if("dark"===e){const e=t.bg1?t.bg1:"#2a2b2c",o=t.fg1?t.fg1:"#bbb",a=t.bg2?t.bg2:rF.color.brightness(e,5),l=t.bg3?t.bg3:rF.color.brightness(e,17),c=t.bg3?t.bg3:rF.color.brightness(e,35),p=t.fg2?t.fg2:rF.color.brightness(o,-15),u=t.fg3?t.fg3:rF.color.brightness(o,-20),d=t.fg3?t.fg3:rF.color.brightness(o,-65),h=t.inlineCodeFg?t.inlineCodeFg:"#aaa",m=p,f=a,g=t.headerColor?t.headerColor:rF.color.brightness(e,10),y=t.navBgColor?t.navBgColor:rF.color.brightness(e,10),v=t.navTextColor?t.navTextColor:rF.color.opacity(rF.color.invert(y),"0.50"),b=t.navHoverBgColor?t.navHoverBgColor:rF.color.brightness(y,-15),x=t.navHoverTextColor?t.navHoverTextColor:rF.color.invert(y),w=t.navAccentColor?t.navAccentColor:rF.color.brightness(s,25);r={bg1:e,bg2:a,bg3:l,lightBg:c,fg1:o,fg2:p,fg3:u,lightFg:d,inlineCodeFg:h,primaryColor:s,primaryColorTrans:i,primaryColorInvert:n,selectionBg:m,selectionFg:f,overlayBg:"rgba(80, 80, 80, 0.4)",navBgColor:y,navTextColor:v,navHoverBgColor:b,navHoverTextColor:x,navAccentColor:w,navAccentTextColor:t.navAccentTextColor?t.navAccenttextColor:rF.color.invert(w),headerColor:g,headerColorInvert:rF.color.invert(g),headerColorDarker:rF.color.brightness(g,-20),headerColorBorder:rF.color.brightness(g,10),borderColor:t.borderColor||rF.color.brightness(e,20),lightBorderColor:t.lightBorderColor||rF.color.brightness(e,15),codeBorderColor:t.codeBorderColor||rF.color.brightness(e,30),inputBg:t.inputBg||rF.color.brightness(e,-5),placeHolder:t.placeHolder||rF.color.opacity(o,"0.3"),hoverColor:t.hoverColor||rF.color.brightness(e,-10),red:t.red?t.red:"#F06560",lightRed:t.lightRed?t.lightRed:rF.color.brightness(e,-10),pink:t.pink?t.pink:"#ffb2b2",lightPink:t.lightPink||rF.color.brightness(e,-10),green:t.green||"#7ec699",lightGreen:t.lightGreen||rF.color.brightness(e,-10),blue:t.blue||"#71b7ff",lightBlue:t.lightBlue||rF.color.brightness(e,-10),orange:t.orange?t.orange:"#f08d49",lightOrange:t.lightOrange||rF.color.brightness(e,-10),yellow:t.yellow||"#827717",lightYellow:t.lightYellow||rF.color.brightness(e,-10),purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",codeBg:t.codeBg||rF.color.opacity(rF.color.brightness(e,-15),.7),codeFg:t.codeFg||"#aaa",codePropertyColor:t.codePropertyColor||"#f8c555",codeKeywordColor:t.codeKeywordColor||"#cc99cd",codeOperatorColor:t.codeOperatorColor||"#67cdcc"}}else{const e=t.bg1?t.bg1:"#fafbfc",o=t.fg1?t.fg1:"#444444",a=t.bg2?t.bg2:rF.color.brightness(e,-5),l=t.bg3?t.bg3:rF.color.brightness(e,-15),c=t.bg3?t.bg3:rF.color.brightness(e,-45),p=t.fg2?t.fg2:rF.color.brightness(o,17),u=t.fg3?t.fg3:rF.color.brightness(o,30),d=t.fg3?t.fg3:rF.color.brightness(o,70),h=t.inlineCodeFg?t.inlineCodeFg:"brown",m=p,f=a,g=t.headerColor?t.headerColor:rF.color.brightness(e,-180),y=t.navBgColor?t.navBgColor:rF.color.brightness(e,-200),v=t.navTextColor?t.navTextColor:rF.color.opacity(rF.color.invert(y),"0.65"),b=t.navHoverBgColor?t.navHoverBgColor:rF.color.brightness(y,-15),x=t.navHoverTextColor?t.navHoverTextColor:rF.color.invert(y),w=t.navAccentColor?t.navAccentColor:rF.color.brightness(s,25);r={bg1:e,bg2:a,bg3:l,lightBg:c,fg1:o,fg2:p,fg3:u,lightFg:d,inlineCodeFg:h,primaryColor:s,primaryColorTrans:i,primaryColorInvert:n,selectionBg:m,selectionFg:f,overlayBg:"rgba(0, 0, 0, 0.4)",navBgColor:y,navTextColor:v,navHoverBgColor:b,navHoverTextColor:x,navAccentColor:w,navAccentTextColor:t.navAccentTextColor?t.navAccenttextColor:rF.color.invert(w),headerColor:g,headerColorInvert:rF.color.invert(g),headerColorDarker:rF.color.brightness(g,-20),headerColorBorder:rF.color.brightness(g,10),borderColor:t.borderColor||rF.color.brightness(e,-38),lightBorderColor:t.lightBorderColor||rF.color.brightness(e,-23),codeBorderColor:t.codeBorderColor||"transparent",inputBg:t.inputBg||rF.color.brightness(e,10),placeHolder:t.placeHolder||rF.color.brightness(d,20),hoverColor:t.hoverColor||rF.color.brightness(e,-5),red:t.red||"#F06560",lightRed:t.lightRed||"#fff0f0",pink:t.pink?t.pink:"#990055",lightPink:t.lightPink?t.lightPink:"#ffb2b2",green:t.green||"#690",lightGreen:t.lightGreen||"#fbfff0",blue:t.blue||"#47AFE8",lightBlue:t.lightBlue||"#eff8fd",orange:t.orange||"#FF9900",lightOrange:t.lightOrange||"#fff5e6",yellow:t.yellow||"#827717",lightYellow:t.lightYellow||"#fff5cc",purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",codeBg:t.codeBg||rF.color.opacity(rF.color.brightness(e,-15),.7),codeFg:t.codeFg||"#666",codePropertyColor:t.codePropertyColor||"#905",codeKeywordColor:t.codeKeywordColor||"#07a",codeOperatorColor:t.codeOperatorColor||"#9a6e3a"}}return G`
  <style>
  *, *:before, *:after { box-sizing: border-box; }
  ...
  :host {
  ...
  </style>`}function iF(e=!1,t=!1){if(!this.resolvedSpec)return"";"true"===this.persistAuth&&N_.call(this);const r={bg1:sF(this.bgColor)?this.bgColor:"",fg1:sF(this.textColor)?this.textColor:"",headerColor:sF(this.headerColor)?this.headerColor:"",primaryColor:sF(this.primaryColor)?this.primaryColor:"",navBgColor:sF(this.navBgColor)?this.navBgColor:"",navTextColor:sF(this.navTextColor)?this.navTextColor:"",navHoverBgColor:sF(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:sF(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:sF(this.navAccentColor)?this.navAccentColor:"",navAccentTextColor:sF(this.navAccentTextColor)?this.navAccentTextColor:""};return this.resolvedSpec.specLoadError?G`
      ${"dark"===this.theme?nF.call(this,"dark",r):nF.call(this,"light",r)}
    ...
    <!-- Header -->
    ${"false"===this.showHeader?"":QR.call(this)}

    <!-- Advanced Search -->
    ${"false"===this.allowAdvancedSearch?"":tF.call(this)}
    ...
    <div id='the-main-body' class='body ${this.cssClasses}' dir='${this.pageDirection}' >
      ...
      <main class='main-content regular-font' tabindex='-1' part='section-main-content'>
        <slot></slot>
        <div class='main-content-inner--${this.renderStyle}-mode'>
          ${!0===this.loading?G`<div class='loader'></div>`:G`
              ${!0===this.loadFailed?G`<div style='text-align: center;margin: 16px;'> Unable to load the Spec</div>`:G`
                  <div class='operations-root' @click='${e=>{this.handleHref(e)}}'>
                  ${"focused"===this.renderStyle?G`${WR.call(this)}`:G`
                      ${"true"===this.showInfo?RR.call(this):""}
                      ${"true"===this.allowServerSelection?DR.call(this):""}
                      ${"true"===this.allowAuthentication?K_.call(this):""}
                      <div id='operations-top' class='observe-me'>
                        <slot name='operations-top'></slot>
                      </div>
                      ${"read"===this.renderStyle?TR.call(this):ZR.call(this,e,t)}
                    `}
                  </div>
                `}`}
        </div>
  ...
  <nav class='nav-bar' part="section-navbar">
    ...
    <nav style="flex:1" class='nav-scroll' part="section-navbar-scroll">
      ${this.resolvedSpec.schemaAndExamples.map((e=>G`
  ...
  `}function lF(){return G`
    ${"true"===this.showInfo?RR.call(this):""}
    <div style="font-size:var(--font-size-regular);">
    ${this.resolvedSpec.schemaAndExamples.map((e=>{var t;const r=$R(e.schema,"json",uR(e.examples),uR(e.example),!0,!1,"json",!0);return e.selectedExample=null===(t=r[0])||void 0===t?void 0:t.exampleId,G`
        <section id='${e.elementId}' class='json-schema-and-example regular-font' style="display:flex; flex-direction: column; border:1px solid var(--border-color); margin-bottom:32px; border-top: 5px solid var(--border-color)">
          <div style="padding:16px; border-bottom: 1px solid var(--border-color)">
            ...
            <span class="json-schema-description m-markdown ">${I_(Ke(e.description||""))}</span>
          </div>
          <div style="display:flex; flex-direction: row; gap:16px;">
            ...
            <div class="json-schema-example-panel" style="width:400px; background-color: var(--input-bg); padding:16px 0 16px 16px; border-left: 1px dashed var(--border-color);">
              ${r.length>1?G`<select style="min-width:100px; max-width:100%" @change='${t=>this.onSelectExample(t,e)}'>
                    ${r.map((t=>G`
                      <option value="${t.exampleId}" ?selected=${t.exampleId===e.selectedExample}>
                        ${t.exampleSummary.length>80?t.exampleId:t.exampleSummary}
                      </option>`))}
                  </select>`:G`<div style="font-size: var(--font-size-small);font-weight:700; margin:5px 0"> ${r[0].exampleSummary}</div>`}
              ${r.map((t=>G`
                <json-tree
                  .data = "${t.exampleValue}"
  ...
  `}function cF(e=!1){if(!this.resolvedSpec)return"";const t={bg1:sF(this.bgColor)?this.bgColor:"",fg1:sF(this.textColor)?this.textColor:"",headerColor:sF(this.headerColor)?this.headerColor:"",primaryColor:sF(this.primaryColor)?this.primaryColor:"",navBgColor:sF(this.navBgColor)?this.navBgColor:"",navTextColor:sF(this.navTextColor)?this.navTextColor:"",navHoverBgColor:sF(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:sF(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:sF(this.navAccentColor)?this.navAccentColor:"",navAccenttextColor:sF(this.navAccentTextColor)?this.navAccentTextColor:""};return this.resolvedSpec.specLoadError?e?G`
        ${"dark"===this.theme?nF.call(this,"dark",t):nF.call(this,"light",t)}
