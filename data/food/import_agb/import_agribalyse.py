...
PROJECT = "AGB3.1.1"
AGRIBALYSEDB = "agribalyse3.1"
TECHNOSPHERE = "agb-technosphere"
BIOSPHERE = AGRIBALYSEDB + " biosphere"

with ZipFile(AGRIBALYSE_CSV + ".zip") as zf:
...
call("sed -i 's/yield/Yield_/g' " + AGRIBALYSE_CSV, shell=True)
call("sed -i 's/01\\/03\\/2005/1\\/3\\/5/g' " + AGRIBALYSE_CSV, shell=True)
call("sed -i 's/0;001172/0,001172/' " + AGRIBALYSE_CSV, shell=True)
...
agb_importer = bw2io.importers.simapro_csv.SimaProCSVImporter(
    AGRIBALYSE_CSV, AGRIBALYSEDB
)

agb_technosphere_migration = bw2io.migrations.Migration(TECHNOSPHERE)
...
#    [bw2data.Database(BIOSPHERE), bw2data.Database(AGRIBALYSEDB)],
#    filename=AGRIBALYSEDB,
