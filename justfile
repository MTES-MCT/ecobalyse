...
fix-json +target="data":
  {{uv}} run --group data python ./data/bin/json_formatter.py --fix {{target}}

check-python +target="data":
  {{uv}} run --group data ruff check --force-exclude --extend-select I {{target}}
  {{uv}} run --group data ruff format --force-exclude --check {{target}}

fix-python +target="data":
  {{uv}} run --group data ruff check --force-exclude --extend-select I --fix {{target}}
