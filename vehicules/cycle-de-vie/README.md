...
{% content-ref url="../../draft-documentation-transverse/transport/transport-vehicules.md" %}
[transport-vehicules.md](../../draft-documentation-transverse/transport/transport-vehicules.md)
{% endcontent-ref %}
