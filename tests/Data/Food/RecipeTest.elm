                ...
                ( Ok royalPizza, ( Ok eggId, Ok mangoId, Ok wheatId ) ) ->
                                ...
                                (case royalPizzaResults |> Result.map (Tuple.second >> .scoring) of
                                    ...
                                    Ok scoring ->
                                        ...
                                        , Unit.impactToFloat scoring.biodiversity
                                            |> Expect.within (Expect.Absolute 0.01) 212.24
                    ...
                    , describe "getMassAtPackaging"
                        ...
                        , royalPizza
                            |> Recipe.compute db
                            |> Result.map (Tuple.first >> Recipe.getMassAtPackaging db.food.wellKnown)
                            |> Expect.equal (Ok (Mass.kilograms 0.3503724000000001))
