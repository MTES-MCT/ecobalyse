...
defaultImpacts : List Definition -> Impacts
defaultImpacts defs =
    Impact.noImpacts
        |> Impact.updateImpact defs (Impact.trg "cch") Quantity.zero
        |> Impact.updateImpact defs (Impact.trg "fwe") Quantity.zero
...
suite : Test
suite =
    suiteWithDb "Data.Textile.Formula"
        (\{ textileDb } ->
                        ...
                        res =
                            kg 1
                                |> Formula.makingImpacts
                                    (defaultImpacts textileDb.impacts)
                                    ...
                                    , countryElecProcess =
                                        { noOpProcess
                                            | impacts =
                                                Impact.noImpacts
                                                    |> Impact.updateImpact textileDb.impacts (Impact.trg "cch") (Unit.impact 0.5)
                                                    |> Impact.updateImpact textileDb.impacts (Impact.trg "fwe") (Unit.impact 1.5)
                                        }
                                    , countryHeatProcess =
                                        { noOpProcess
                                            | impacts =
                            ...
                            Formula.weavingImpacts
                                ...
                                { countryElecProcess =
                                    { noOpProcess
                                        | impacts =
                                            Impact.noImpacts
                                                |> Impact.updateImpact textileDb.impacts (Impact.trg "cch") (Unit.impact 8.13225e-2)
                                                |> Impact.updateImpact textileDb.impacts (Impact.trg "fwe") (Unit.impact 3.26897e-8)
                                    }
                                , outputMass = kg 0.478
                                , pickingElec = 1
                                ...
                                |> Formula.knittingImpacts
                                    ...
                                    , countryElecProcess =
                                        { noOpProcess
                                            | impacts =
                                                Impact.noImpacts
                                                    |> Impact.updateImpact textileDb.impacts (Impact.trg "cch") (Unit.impact 0.2)
                                                    |> Impact.updateImpact textileDb.impacts (Impact.trg "fwe") (Unit.impact 0.5)
                                        }
                                    }
                     in
                     [ res.impacts
