        ...
        [ describe "update"
            ...
            , describe "Successful poll"
                ...
                , Success { hash = "hash", tag = Just "tag" }
                    |> Version.update (Version { hash = "hash", tag = Just "tag" })
                ...
                , Success { hash = "hash2", tag = Nothing }
                    |> Version.update (Version { hash = "hash1", tag = Nothing })
